...
# class VTAUop(Structure):
#     _fields_ = [("dst_idx", c_uint32, VTA_LOG_ACC_BUFF_DEPTH),
#                 ("src_idx", c_uint32, VTA_LOG_INP_BUFF_DEPTH),
#                 ("wgt_idx", c_uint32, VTA_LOG_WGT_BUFF_DEPTH)]
...
pack_buffer = wrap_function(testlib, 'packBufferWrap', None, [c_int, c_void_p, POINTER(c_void_p), c_int, c_int, c_int, c_int])
unpack_buffer = wrap_function(testlib, 'unpackBufferWrap', None, [POINTER(POINTER(out_T)), POINTER(c_uint32), c_int, c_int, c_int, c_int])
alloc_2darray = wrap_function(testlib, 'alloc2dArrayWrap', POINTER(POINTER(out_T)), [c_int, c_int])
concat_uop = wrap_function(testlib, 'concatUop', None, [POINTER(VTAUop), POINTER(VTAUop), c_size_t, c_size_t])

"""Get Instructions, Uops and Opcodes"""
get_alu_insn = wrap_function(testlib, 'getALUInsn', VTAGenericInsn, [c_int, c_int, c_bool, c_int, c_bool, c_int, c_int, c_int, c_int])
get_gemm_insn = wrap_function(testlib, 'getGEMMInsn', VTAGenericInsn, [c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int])
...
get_gemm_uops = wrap_function(testlib, 'getGEMMUops', POINTER(VTAUop), [c_int, c_int, c_int, c_bool, c_bool])
...
get_1Dloadstore_insn = wrap_function(testlib, 'get1DLoadStoreInsn', VTAGenericInsn, [c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int])
get_2Dloadstore_insn = wrap_function(testlib, 'get2DLoadStoreInsn', VTAGenericInsn, [c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int])
...
vta_run = wrap_function(testlib, 'vta', c_uint64, [c_uint32, POINTER(VTAGenericInsn), POINTER(VTAUop), POINTER(c_uint32), POINTER(c_uint32), POINTER(c_uint32), POINTER(c_uint32)])
