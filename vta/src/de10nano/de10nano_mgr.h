...
#ifndef DE10NANO_FPGA_MGR_H
#define DE10NANO_FPGA_MGR_H
...
struct de10nano_mgr
{
  ...
  de10nano_mgr ()
  {
    ...
    #ifdef MOCK_DEVMEM
    m_regs_base = (uint8_t*) malloc (m_page_size);
    m_data_base = (uint8_t*) malloc (m_page_size);
    #else
