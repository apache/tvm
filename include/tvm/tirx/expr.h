 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<StringImmNode>()
        ...
        .def_ir_traits<tr::LiteralTraitsObj>("$field:value", "string");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<CastNode>()
        ...
        .def_ir_traits<tr::CallTraitsObj>("T.Cast", "$global:tirx._cast_args");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<AddNode>()
        .def_ro("a", &AddNode::a)
        .def_ro("b", &AddNode::b)
        .def_ir_traits<tr::BinOpTraitsObj>("$field:a", "$field:b", "+",
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ModNode>()
        .def_ro("a", &ModNode::a)
        .def_ro("b", &ModNode::b)
        .def_ir_traits<tr::BinOpTraitsObj>("$field:a", "$field:b", "truncmod");
  }
};
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<MinNode>()
        .def_ro("a", &MinNode::a)
        .def_ro("b", &MinNode::b)
        .def_ir_traits<tr::BinOpTraitsObj>("$field:a", "$field:b", "min");
  }
};
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<MaxNode>()
        .def_ro("a", &MaxNode::a)
        .def_ro("b", &MaxNode::b)
        .def_ir_traits<tr::BinOpTraitsObj>("$field:a", "$field:b", "max");
  }
};
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<AndNode>()
        .def_ro("a", &AndNode::a)
        .def_ro("b", &AndNode::b)
        .def_ir_traits<tr::BinOpTraitsObj>("$field:a", "$field:b", "and",
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<OrNode>()
        .def_ro("a", &OrNode::a)
        .def_ro("b", &OrNode::b)
        .def_ir_traits<tr::BinOpTraitsObj>("$field:a", "$field:b", "or",
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<NotNode>()
        .def_ro("a", &NotNode::a)
        .def_ir_traits<tr::UnaryOpTraitsObj>("$field:a", "not");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<SelectNode>()
        ...
        .def_ir_traits<tr::CallTraitsObj>("T.Select", "$global:tirx._select_args");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<BufferLoadNode>()
        ...
        .def_ir_traits<tr::LoadTraitsObj>("$field:buffer", "$global:tirx._load_indices",
                                   "$field:predicate");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ProducerLoadNode>()
        ...
        .def_ir_traits<tr::LoadTraitsObj>("$field:producer", "$field:indices");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<RampNode>()
        ...
        .def_ir_traits<tr::CallTraitsObj>("T.Ramp", "$global:tirx._ramp_args");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<BroadcastNode>()
        ...
        .def_ir_traits<tr::CallTraitsObj>("T.Broadcast", "$global:tirx._broadcast_args");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<CallNode>()
        ...
        .def_ir_traits<tr::CallTraitsObj>("$global:tirx._call_callee", "$global:tirx._call_args",
                                     nullptr, nullptr, "$global:tirx._tir_call_callee");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ShuffleNode>()
        ...
        .def_ir_traits<tr::CallTraitsObj>("T.Shuffle", "$global:tirx._shuffle_args");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<CommReducerNode>()
        ...
        .def_ir_traits<tr::CallTraitsObj>("comm_reducer", "$field:lhs");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ReduceNode>()
        ...
        .def_ir_traits<tr::CallTraitsObj>("T.reduce", "$global:tirx._reduce_positional",
