 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<AssertStmtNode>()
        ...
        .def_ir_traits<tr::AssertTraitsObj>("$field:condition", "$global:tirx._structured_msg");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<BufferStoreNode>()
        ...
        .def_ir_traits<tr::StoreTraitsObj>("$field:buffer", "$field:value",
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<SeqStmtNode>()
        ...
        .def_ir_traits<tr::WithTraitsObj>(tr::RegionTraits("$field:seq"));
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<EvaluateNode>()
        ...
        .def_ir_traits<tr::AssignTraitsObj>(nullptr, "$global:tirx._evaluate_expr",
                                      nullptr, nullptr,
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<IfThenElseNode>()
        ...
        .def_ir_traits<tr::IfTraitsObj>("$field:condition",
                                  tr::RegionTraits("$field:then_case"),
                                  ffi::Optional<tr::RegionTraits>(tr::RegionTraits("$field:else_case")));
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<WhileNode>()
        ...
        .def_ir_traits<tr::WhileTraitsObj>("$field:condition", tr::RegionTraits("$field:body"));
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<BufferRegionNode>()
        ...
        .def_ir_traits<tr::LoadTraitsObj>("$field:buffer", "$global:tirx._buf_region_indices");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<SBlockNode>()
        ...
        .def_ir_traits<tr::WithTraitsObj>(tr::RegionTraits("$field:body", "$field:iter_vars"));
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<SBlockRealizeNode>()
        ...
        .def_ir_traits<tr::WithTraitsObj>(tr::RegionTraits("$field:block"));
  }
