...
/*! \brief An operator argument's name, native FFI type schema, and documentation. */
class ArgumentInfoNode : public ffi::Object {
 public:
  /*! \brief Argument name. */
  ffi::String name;
  /*! \brief JSON type schema generated by native FFI reflection. */
  ffi::String type_schema;
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ArgumentInfoNode>()
        ...
        .def_ro("type_schema", &ArgumentInfoNode::type_schema)
...
class OpDef {
 public:
   ...
   */
  TVM_DLL OpDef& arg(const ffi::String& name, const ffi::String& type_schema, const ffi::String& doc);
  /*!
