 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<TupleNode>()
        ...
        .def_ir_traits<tr::CallObj>("Tuple", "$field:fields");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<TupleGetItemNode>()
        ...
        .def_ir_traits<tr::LoadObj>("$field:tuple_value", "$field:index");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ShapeExprNode>()
        ...
        .def_ir_traits<tr::CallObj>("R.shape", "$global:relax._shape_args");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<VarNode>()
        ...
        .def_ir_traits<tr::ValueObj>("$field:vid");
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ConstantNode>()
        ...
        .def_ir_traits<tr::LiteralObj>("$field:data", "constant");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<PrimValueNode>()
        ...
        .def_ir_traits<tr::CallObj>("R.prim_value", "$field:value");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<StringImmNode>()
        ...
        .def_ir_traits<tr::CallObj>("R.str", "$field:value");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<DataTypeImmNode>()
        ...
        .def_ir_traits<tr::CallObj>("R.dtype", "$global:relax._dtype_str");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<BindingBlockNode>()
        ...
        .def_ir_traits<tr::SeqObj>("$field:bindings", nullptr, ffi::Optional<bool>(true));
  }
 ...
 public:
  static void RegisterReflection() {
    ...
    refl::ObjectDef<DataflowBlockNode>()
        .def_ir_traits<tr::WithObj>(tr::Region("$field:bindings"),
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<SeqExprNode>()
        ...
        .def_ir_traits<tr::SeqObj>("$field:blocks", "$field:body", ffi::Optional<bool>(true));
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ExternFuncNode>()
        ...
        .def_ir_traits<tr::CallObj>("R.ExternFunc", "$field:global_symbol");
  }
