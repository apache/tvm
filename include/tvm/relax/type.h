 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<ShapeTypeNode>()
        ...
        .def_ir_traits<tr::ShapeTyTraitsObj>(nullptr, "$field:ndim");
  }
 ...
 public:
  ...
  static void RegisterReflection() {
    ...
    refl::ObjectDef<TensorTypeNode>()
        ...
        .def_ir_traits<tr::TensorTyTraitsObj>(nullptr, "$field:dtype");
  }
 ...
 public:
  static void RegisterReflection() {
    ...
    refl::ObjectDef<PackedFuncTypeNode>()
        .def_ir_traits<tr::FuncTyTraitsObj>();
  }
