...
struct Conv1DAttrs : public AttrsNodeReflAdapter<Conv1DAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.Conv1DAttrs", Conv1DAttrs, BaseAttrsNode);
};  // struct Conv1dAttrs
...
struct Conv2DAttrs : public AttrsNodeReflAdapter<Conv2DAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.Conv2DAttrs", Conv2DAttrs, BaseAttrsNode);
};  // struct Conv2dAttrs
...
struct Conv3DAttrs : public AttrsNodeReflAdapter<Conv3DAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.Conv3DAttrs", Conv3DAttrs, BaseAttrsNode);
};  // struct Conv3dAttrs
...
struct Conv1DTransposeAttrs : public AttrsNodeReflAdapter<Conv1DTransposeAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.Conv1DTransposeAttrs", Conv1DTransposeAttrs,
                                    BaseAttrsNode);
...
struct Conv2DTransposeAttrs : public AttrsNodeReflAdapter<Conv2DTransposeAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.Conv2DTransposeAttrs", Conv2DTransposeAttrs,
                                    BaseAttrsNode);
...
struct Pool1DAttrs : public AttrsNodeReflAdapter<Pool1DAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.Pool1DAttrs", Pool1DAttrs, BaseAttrsNode);
};  // struct Pool1dAttrs
...
struct Pool2DAttrs : public AttrsNodeReflAdapter<Pool2DAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.Pool2DAttrs", Pool2DAttrs, BaseAttrsNode);
};  // struct Pool2dAttrs
...
struct Pool3DAttrs : public AttrsNodeReflAdapter<Pool3DAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.Pool3DAttrs", Pool3DAttrs, BaseAttrsNode);
};  // struct Pool3dAttrs
...
struct AdaptivePool1DAttrs : public AttrsNodeReflAdapter<AdaptivePool1DAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.AdaptivePool1DAttrs", AdaptivePool1DAttrs,
                                    BaseAttrsNode);
...
struct SoftmaxAttrs : public AttrsNodeReflAdapter<SoftmaxAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.SoftmaxAttrs", SoftmaxAttrs, BaseAttrsNode);
};
...
struct LeakyReluAttrs : public AttrsNodeReflAdapter<LeakyReluAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.LeakyReluAttrs", LeakyReluAttrs,
                                    BaseAttrsNode);
};
...
struct SoftplusAttrs : public AttrsNodeReflAdapter<SoftplusAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.SoftplusAttrs", SoftplusAttrs, BaseAttrsNode);
};
...
struct PReluAttrs : public AttrsNodeReflAdapter<PReluAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.PReluAttrs", PReluAttrs, BaseAttrsNode);
};
...
struct BatchNormAttrs : public AttrsNodeReflAdapter<BatchNormAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.BatchNormAttrs", BatchNormAttrs,
                                    BaseAttrsNode);
...
struct LayerNormAttrs : public AttrsNodeReflAdapter<LayerNormAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.LayerNormAttrs", LayerNormAttrs,
                                    BaseAttrsNode);
...
struct GroupNormAttrs : public AttrsNodeReflAdapter<GroupNormAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.GroupNormAttrs", GroupNormAttrs,
                                    BaseAttrsNode);
...
struct InstanceNormAttrs : public AttrsNodeReflAdapter<InstanceNormAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.InstanceNormAttrs", InstanceNormAttrs,
                                    BaseAttrsNode);
...
struct RMSNormAttrs : public AttrsNodeReflAdapter<RMSNormAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.RMSNormAttrs", RMSNormAttrs, BaseAttrsNode);
};  // struct RMSNormAttrs
...
struct NLLLossAttrs : public AttrsNodeReflAdapter<NLLLossAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.NLLLossAttrs", NLLLossAttrs, BaseAttrsNode);
};  // struct NLLLossAttrs
...
struct DropoutAttrs : public AttrsNodeReflAdapter<DropoutAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.DropoutAttrs", DropoutAttrs, BaseAttrsNode);
};  // struct DropoutAttrs
...
struct AttentionAttrs : public AttrsNodeReflAdapter<AttentionAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.AttentionAttrs", AttentionAttrs,
                                    BaseAttrsNode);
...
struct PadAttrs : public AttrsNodeReflAdapter<PadAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.PadAttrs", PadAttrs, BaseAttrsNode);
};
...
struct PixelShuffleAttrs : public AttrsNodeReflAdapter<PixelShuffleAttrs> {
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm.relax.attrs.PixelShuffleAttrs", PixelShuffleAttrs,
                                    BaseAttrsNode);
};
