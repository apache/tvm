...
/*! \brief Attributes for DeformableV2Conv2D operator */
struct DeformableV2Conv2DAttrs : public tvm::AttrsNode<DeformableV2Conv2DAttrs> {
  Array<IndexExpr> strides;
  Array<IndexExpr> padding;
  Array<IndexExpr> dilation;
  int deformable_groups;
  ...
  TVM_DECLARE_ATTRS(DeformableV2Conv2DAttrs, "relay.attrs.DeformableV2Conv2DAttrs") {
    TVM_ATTR_FIELD(strides)
        .set_default(Array<IndexExpr>({1, 1}))
        .describe("Specifies the strides of the convolution.");
    TVM_ATTR_FIELD(padding)
