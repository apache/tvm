...
class ExprFunctor<R(const Expr& n, Args...)> {
 ...
 public:
  ...
  virtual R VisitExpr_(const OpNode* op,
                       Args... args) EXPR_FUNCTOR_DEFAULT;
  virtual R VisitExpr_(const GetItemNode* op, Args... args) EXPR_FUNCTOR_DEFAULT;
 ...
 private:
  ...
  static FType InitVTable() {
    ...
    RELAY_EXPR_FUNCTOR_DISPATCH(GetItemNode);
    return vtable;
  }
};
...
class ExprVisitor : public ::tvm::relay::ExprFunctor<void(const Expr& n)> {
 public:
  ...
  void VisitExpr_(const GetItemNode* op) override;
...
class ExprMutator
 ...
 public:
  ...
  Expr VisitExpr_(const GetItemNode* op) override;
