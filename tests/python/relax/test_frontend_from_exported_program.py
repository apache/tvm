    ...
    class expected_elu:
        ...
        def main(
            ...
            with R.dataflow():
                ...
                lv_one_minus_exp: R.Tensor((1, 3, 10, 10), dtype="float32") = R.subtract(R.const(1.0, dtype="float32"), lv_exp)
    ...
    class expected_selu:
        ...
        def main(
            ...
            with R.dataflow():
                ...
                lv_selu: R.Tensor((1, 3, 10, 10), dtype="float32") = R.multiply(R.const(1.0507010221481323, "float32"),
                                                                                lv_add)
