...
def test_conv2d_tile():
    ...
    class Input:
        ...
        def main(
            ...
            with R.dataflow():
                gv: R.Tensor((2, 4, 26, 26), "float32") = R.nn.conv2d(x, w, out_dtype="float32")
                gv2: R.Tensor((4, 4, 26, 26), "float32") = R.tile(gv, repeats=(2, 1, 1, 1))
                R.output(gv2)
            return gv2
    ...
    class Expected:
        ...
        def main(
            ...
            with R.dataflow():
                ...
                lv2: R.Tensor((4, 26, 26, 4), dtype="float32") = R.tile(gv, repeats=(2, 1, 1, 1))
                gv2: R.Tensor((4, 4, 26, 26), dtype="float32") = R.permute_dims(
                    lv2, axes=[0, 3, 1, 2]
                )
                R.output(gv2)
            return gv2
