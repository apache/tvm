...
class ShardedMLPDynamicShape:
    ...
    def foo(
        ...
        lv3: R.DTensor((m, n), "float32", "mesh[0]", "R") = R.matmul(lv1, weight2, out_dtype="void")
        return lv3
...
class ShardedLlamaAttentionLayerTIR:
    ...
    def minimum(
        ...
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(32), T.int64(256), T.int64(256)):
            with T.block("T_minimum"):
                v_ax0 = T.axis.spatial(T.int64(1), T.int64(0))
                v_ax1, v_ax2, v_ax3 = T.axis.remap("SSS", [ax1, ax2, ax3])
                T.reads(A[T.int64(0), v_ax1, v_ax2, v_ax3], B[T.int64(0), T.int64(0), v_ax2, v_ax3])
    ...
    def softmax(
        A: T.Buffer((T.int64(1), T.int64(32), T.int64(256), T.int64(256)), "float16"),
        T_softmax_norm: T.Buffer((T.int64(1), T.int64(32), T.int64(256), T.int64(256)), "float16"),
    ):
        T.func_attr({"tir.noalias": T.bool(True)})
        # with T.block("root"):
        ...
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(32), T.int64(256), T.int64(256)):
            with T.block("T_softmax_exp"):
                v_i0 = T.axis.spatial(T.int64(1), T.int64(0))
                v_i1, v_i2, v_i3 = T.axis.remap("SSS", [i1, i2, i3])
                T.reads(A[T.int64(0), v_i1, v_i2, v_i3], T_softmax_maxelem[T.int64(0), v_i1, v_i2])
    ...
    def transpose1(
        ...
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(32), T.int64(256), T.int64(128)):
            with T.block("T_transpose"):
                ...
                T_transpose[T.int64(0), v_ax1, v_ax2, v_ax3] = A[T.int64(0), v_ax2, v_ax1, v_ax3]
    ...
    def transpose2(
        ...
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(32), T.int64(128), T.int64(256)):
            with T.block("T_transpose"):
                ...
                T.writes(T_transpose[T.int64(0), v_ax1, v_ax2, v_ax3])
                T_transpose[T.int64(0), v_ax1, v_ax2, v_ax3] = A[T.int64(0), v_ax1, v_ax3, v_ax2]
    ...
    def foo(
        ...
        lv18 = R.dist.call_tir(
            cls.reshape1, (lv17,), out_sinfo=R.DTensor((256, 32, 128), "float16", "mesh[0]", "S[1]")
        )
        lv19 = R.dist.call_tir(
            cls.reshape1, (lv15,), out_sinfo=R.DTensor((256, 32, 128), "float16", "mesh[0]", "S[1]")
        )
        lv20: R.Object = kv_cache[0]
        lv21: R.Object = R.call_packed(
            "vm.builtin.distributed.attention_kv_cache_append", lv20, lv18, sinfo_args=(R.Object,)
        ...
        lv41 = R.dist.call_tir(
            cls.reshape3, (lv40,), out_sinfo=R.DTensor((1, 256, 4096), "float16", "mesh[0]", "S[2]")
        )
        ...
        lv43 = R.dist.call_tir(
            cls.matmul, (lv41, lv42), out_sinfo=R.DTensor((1, 256, 4096), "float16", "mesh[0]", "R")
        )
