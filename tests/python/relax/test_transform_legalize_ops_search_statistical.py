...
def test_argmax_symbolic():
    ...
    class Expected:
        ...
        def argmax(var_rxplaceholder: T.handle, var_rxplaceholder_red: T.handle):
            ...
            # with Ts.sblock("root"):
            rxplaceholder_red_temp_v0 = Ts.sblock_alloc_buffer((a, T.int64(1), c, d), "int64")
            rxplaceholder_red_temp_v1 = Ts.sblock_alloc_buffer((a, T.int64(1), c, d))
...
def test_mean_symbolic():
    ...
    class Expected:
        ...
        def mean(var_rxplaceholder: T.handle, var_T_divide: T.handle):
            ...
            rxplaceholder_red = Ts.sblock_alloc_buffer([b, c], dtype="float32")
...
def test_std_symbolic():
    ...
    class Expected:
        ...
        def std(var_rxplaceholder: T.handle, compute: T.Buffer((), "float32")):
            ...
            rxplaceholder_red = Ts.sblock_alloc_buffer((T.int64(1), T.int64(1), T.int64(1), T.int64(1)))
            T_divide = Ts.sblock_alloc_buffer((T.int64(1), T.int64(1), T.int64(1), T.int64(1)))
            T_subtract = Ts.sblock_alloc_buffer((a, b, c, d))
            T_multiply = Ts.sblock_alloc_buffer((a, b, c, d))
            T_multiply_red = Ts.sblock_alloc_buffer(())
            T_divide_1 = Ts.sblock_alloc_buffer(())
            for ax0, ax1, ax2, ax3, k0, k1, k2, k3 in T.grid(T.int64(1), T.int64(1), T.int64(1), T.int64(1), a, b, c, d):
                with Ts.sblock("rxplaceholder_red"):
...
def test_variance_symbolic():
    ...
    class Expected:
        ...
        def variance(var_rxplaceholder: T.handle, var_T_divide: T.handle):
            ...
            rxplaceholder_red = Ts.sblock_alloc_buffer([T.int64(1), b, c, T.int64(1)], dtype="float32")
            T_divide_1 = Ts.sblock_alloc_buffer([T.int64(1), b, c, T.int64(1)], dtype="float32")
            T_subtract = Ts.sblock_alloc_buffer([a, b, c, d], dtype="float32")
            T_multiply = Ts.sblock_alloc_buffer([a, b, c, d], dtype="float32")
            T_multiply_red = Ts.sblock_alloc_buffer([T.int64(1), b, c, T.int64(1)], dtype="float32")
