...
def test_dnnl_fuse():
    ...
    (
        ...
        ("dnnl.conv2d_bias_relu", dnnl_pat_dic["dnnl.conv2d_bias_relu"],),
        ("dnnl.conv2d_bias_sigmoid", dnnl_pat_dic["dnnl.conv2d_bias_sigmoid"],),
        ("dnnl.conv2d_bias", dnnl_pat_dic["dnnl.conv2d_bias"],),
        ("dnnl.conv2d_relu", dnnl_pat_dic["dnnl.conv2d_relu"],),
        ("dnnl.conv2d_sigmoid", dnnl_pat_dic["dnnl.conv2d_sigmoid"],),
    )
