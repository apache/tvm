...
def test_tflite_model_u1_usecase(model_url, usmp_algo, workspace_size):
    ...
    mod, inputs, params = get_relay_module_and_inputs_from_tflite_file(tflite_model_file)
...
def test_tflite_model_u2_usecase_two_models_with_a_single_external_pool(model_urls, usmp_algo):
    ...
    mod1, inputs1, params1 = get_relay_module_and_inputs_from_tflite_file(tflite_model_file1)
    ...
    mod2, inputs2, params2 = get_relay_module_and_inputs_from_tflite_file(tflite_model_file2)
