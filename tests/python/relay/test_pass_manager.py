...
def test_sequential_pass():
    ...
    def test_pass_registration():
        ...
        sequential_pass = _transform.sequential_pass(
            passes=passes, opt_level=opt_level)
        assert isinstance(sequential_pass, _transform.SequentialPass)
    ...
    def test_no_pass():
        passes = []
        sequential_pass = _transform.sequential_pass(opt_level=1, passes=passes)
