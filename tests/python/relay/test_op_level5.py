...
def test_multibox_prior():
    ...
    verify_multibox_prior(x, dshape, ref_res, sizes, ratios, steps, offsets,
                          check_size=True)
    y = relay.var("y", relay.TensorType((tvm.shape_var("n"), 3, 56, 56), "float32"))
    verify_multibox_prior(x, dshape, ref_res, sizes, ratios, steps, offsets,
    ...
    y = relay.var("y", relay.TensorType((tvm.shape_var("n"), 24, 32, 32), "float32"))
...
def test_non_max_suppression():
    ...
    dshape = (tvm.shape_var("n"), num_anchors, 6)
