...
def test_fuse_reduction_epilogue_numerical_correctness():  
    ...
    mod_original(tvm.runtime.tensor(A_np), tvm.runtime.tensor(B_np),   
                 tvm.runtime.tensor(C_np), D_original_tvm)  
      
    mod_fused(tvm.runtime.tensor(A_np), tvm.runtime.tensor(B_np),   
              tvm.runtime.tensor(C_np), D_fused_tvm)  
...
def test_fuse_reduction_epilogue_multiple_epilogue():  
    ...
    sch.fuse_reduction_epilogue("multiply", "add")  
    assert_structural_equal_ignore_global_symbol(sch.mod["main"], matmul_bias_multiple_epilogue_expected)  
