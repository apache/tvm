...
def test_multi_level_tiling_hexagon():
    @T.prim_func
    def cpu_conv2d_nhwc(inputs: T.Buffer[(1, 56, 56, 64), "float16"], weight: T.Buffer[(3, 3, 64, 64), "float16"], conv2d_nhwc: T.Buffer[(1, 56, 56, 64), "float16"]) -> None:
        # function attr dict
        T.func_attr({"global_symbol": "main", "tir.noalias": True})
        # body
        # with T.block("root")
        ...
        for i0, i1, i2, i3 in T.grid(1, 58, 58, 64):
            with T.block("PadInput"):
                ...
                PadInput[i0_1, i1_1, i2_1, i3_1] = T.if_then_else(1 <= i1_1 and i1_1 < 57 and 1 <= i2_1 and i2_1 < 57, inputs[i0_1, i1_1 - 1, i2_1 - 1, i3_1], T.float16(0), dtype="float16")
        for i0_0, i1_0, i2_0, i3_0, i4_0, i5_0, i6_0, i0_1_1, i1_1_1, i2_1_1, i3_1_1, i4_1, i5_1, i6_1, i0_2, i1_2, i2_2, i3_2 in T.grid(1, 1, 2, 1, 3, 3, 16, 1, 14, 2, 1, 1, 1, 4, 1, 4, 14, 64):
    ...
    mod = te.create_prim_func(te_workload.conv2d_nhwc(
    ...
    actual = ms.TuneContext(
        ...
        space_generator=ms.space_generator.PostOrderApply(),
        sch_rules=[ms.schedule_rule.MultiLevelTilingWideVector(
            structure="SRSRS",
