                    ...
                    for threadIdx_x in T.thread_binding(2, thread="threadIdx.x"):
                        for k_0 in T.serial(32):
                            with T.block():
                                T.reads(
                                    A[
                                        blockIdx_y * 32 : blockIdx_y * 32 + 32,
                                        k_0 * 32 : k_0 * 32 + 32,
                                    ],
                                    B[
                                        k_0 * 32 : k_0 * 32 + 32,
                                ...
                                A_shared = T.alloc_buffer(
                                    [1024, 1024], dtype="float32", scope="shared"
                                )
                                ...
                                for k_1, i_2, j_2, k_2 in T.grid(2, 16, 16, 16):
                                    with T.block("C"):
                                        T.reads(
                                            A_shared[
                                                blockIdx_y * 32 + threadIdx_y * 16 + i_2,
                                                k_0 * 32 + k_1 * 16 + k_2,
                                            ],
                                            B_shared[
                                                k_0 * 32 + k_1 * 16 + k_2,
                                                blockIdx_x * 32 + threadIdx_x * 16 + j_2,
                                            ],
                                        )
                                        T.writes(
                                            C[
                    ...
                    for threadIdx_x in T.thread_binding(2, thread="threadIdx.x"):
                        for k_0 in T.serial(32):
                            with T.block():
                                ...
                                A_shared_local = T.alloc_buffer(
                                    [64, 4], dtype="float32", scope="local"
                                )
                                B_shared_local = T.alloc_buffer(
                                    [64, 4], dtype="float32", scope="local"
                                )
                                for ax0_ax1_fused_0 in T.serial(64):
                                    for ax0_ax1_fused_3 in T.vectorized(4):
                                        with T.block():
                                            ...
                                            T.writes(
                                                A_shared_local[ax0_ax1_fused_0, ax0_ax1_fused_3]
                                            )
                                            A_shared_local[ax0_ax1_fused_0, ax0_ax1_fused_3] = A[
                                                blockIdx_y * 32
                                                + (
                                                    ax0_ax1_fused_0 * 16
                                                    + threadIdx_y * 8
                                ...
                                for ax0_ax1_fused_0 in T.serial(64):
                                    for ax0_ax1_fused_3 in T.vectorized(4):
                                        with T.block():
                                            ...
                                            T.writes(
                                                B_shared_local[ax0_ax1_fused_0, ax0_ax1_fused_3]
                                            )
                                            B_shared_local[ax0_ax1_fused_0, ax0_ax1_fused_3] = B[
                                                k_0 * 32
                                                + (
                                                    ax0_ax1_fused_0 * 16
                                                    + threadIdx_y * 8
