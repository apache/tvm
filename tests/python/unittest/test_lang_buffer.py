...
def test_buffer_broadcast():
    m0, m1, m2 = tvm.shape_var("m0"), tvm.shape_var("m1"), tvm.shape_var("m2")
    n0, n1, n2 = tvm.shape_var("n0"), tvm.shape_var("n1"), tvm.shape_var("n2")
    o0, o1, o2 = tvm.shape_var("o0"), tvm.shape_var("o1"), tvm.shape_var("o2")
...
def test_buffer_broadcast_expr():
    n0, m0, x = tvm.shape_var('n0'), tvm.shape_var('m0'), tvm.shape_var('x')
    n1, m1 = tvm.shape_var('n1'), tvm.shape_var('m1')
    o0, o1 = tvm.shape_var('o0'), tvm.shape_var('o1')
