...
def test_fuse():
    ...
    sch.fuse(i, j, k)
    assert_structural_equal_gs(elementwise_fused, sch.mod["main"])
...
def test_split():
    ...
    assert_structural_equal_gs(elementwise_split_case0, sch.mod["main"])
    verify_trace_roundtrip(sch=sch, mod=elementwise)
...
def test_split_with_inferred_factor():
    ...
    assert_structural_equal_gs(elementwise_split_case1, sch.mod["main"])
    verify_trace_roundtrip(sch=sch, mod=elementwise)
...
def test_split_with_predicate():
    ...
    assert_structural_equal_gs(elementwise_split_with_predicate, sch.mod["main"])
    verify_trace_roundtrip(sch=sch, mod=elementwise)
...
def test_fuse_with_opaque_block():
    ...
    sch.fuse(i, j, k)
    assert_structural_equal_gs(elementwise_fuse_with_opaque_block, sch.mod["main"])
...
def test_fuse_with_opaque_access():
    ...
    sch.fuse(i, j)
    assert_structural_equal_gs(opaque_access_fused, sch.mod["main"])
...
def test_split_with_opaque_block():
    ...
    assert_structural_equal_gs(elementwise_split_with_opaque_block, sch.mod["main"])
    verify_trace_roundtrip(sch=sch, mod=elementwise_with_opaque_block)
...
def test_split_with_opaque_access():
    ...
    sch.split(j, factors=[None, 4])
    assert_structural_equal_gs(opaque_access_split, sch.mod["main"])
    verify_trace_roundtrip(sch=sch, mod=opaque_access)
...
def test_fuse_symbolic():
    ...
    i, j, k = sch.get_loops(block_b)
    sch.fuse(i, j, k)
    assert_structural_equal_gs(elementwise_symbolic_fused, sch.mod["main"])
...
def test_split_symbolic():
    ...
    assert_structural_equal_gs(elementwise_symbolic_split, sch.mod["main"])
    verify_trace_roundtrip(sch=sch, mod=elementwise_symbolic)
...
def test_fuse_not_affine():
    ...
    _, j, k = sch.get_loops(block_b)
    sch.fuse(j, k)
    assert_structural_equal_gs(elementwise_not_affine_fused, sch.mod["main"])
...
def test_add_unit_loop_above_block():
    ...
    assert_structural_equal_gs(zero_dim_added, sch.mod["main"])
