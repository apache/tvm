...
b3 = sch.reindex(block=b0, buffer=("read", 1))
sch.transform_layout(block=b0, buffer=("read", 0), index_map=lambda i, k: (i, k, ), pad_value=None)
sch.transform_layout(block=b0, buffer=("read", 1), index_map=lambda j, k: (j, k, ), pad_value=None)
sch.transform_layout(block=b0, buffer=("write", 0), index_map=lambda i, j: (i, j, ), pad_value=None)
sch.transform_block_layout(block=b1, index_map=lambda i, j, k: (i, j, k, ))
sch.transform_block_layout(block=b2, index_map=lambda i, j, k: (i, j, k, ))
sch.transform_block_layout(block=b3, index_map=lambda i, j, k: (i, j, k, ))
...
b2 = sch.reindex(block=b0, buffer=("read", 0))
b3 = sch.reindex(block=b0, buffer=("read", 1))
sch.transform_layout(block=b0, buffer=("read", 0), index_map=lambda h, w, rh, rw, rc: (((h*16) + w), (((rh*96) + (rw*32)) + rc), ), pad_value=None)
sch.transform_layout(block=b0, buffer=("read", 1), index_map=lambda co, rh, rw, rc: ((((rh*96) + (rw*32)) + rc), co, ), pad_value=None)
sch.transform_layout(block=b0, buffer=("write", 0), index_map=lambda h, w, co: (((h*16) + w), co, ), pad_value=None)
