...
class LinearStructurePlanned:
    ...
    def tvmgen_default_fused_nn_max_pool2d_cast(placeholder_28: T.handle, T_cast_6: T.handle, fast_memory_6_var: T.handle, slow_memory_7_var: T.handle) -> None:
        ...
        slow_memory_7_buffer_var = T.match_buffer(slow_memory_7_var, [802816], dtype="uint8", strides=[1], elem_offset=1, align=16)
        # body
        tensor_2_let: T.uint8 = T.load("uint8", fast_memory_6_buffer_var.data, 0)
        for ax0_ax1_fused_4, ax2_4 in T.grid(56, 56):
            for ax3_init in T.serial(0, 64):
                T.store(tensor_2_let, ax0_ax1_fused_4 * 3584 + ax2_4 * 64 + ax3_init, T.uint8(0), True)
            for rv0_rv1_fused_1, ax3_2 in T.grid(9, 64):
                T.store(tensor_2_let, ax0_ax1_fused_4 * 3584 + ax2_4 * 64 + ax3_2, T.max(T.load("uint8", tensor_2_let, ax0_ax1_fused_4 * 3584 + ax2_4 * 64 + ax3_2), T.if_then_else(ax0_ax1_fused_4 * 2 + T.floordiv(rv0_rv1_fused_1, 3) < 112 and ax2_4 * 2 + T.floormod(rv0_rv1_fused_1, 3) < 112, T.load("uint8", placeholder_29.data, ax0_ax1_fused_4 * 14336 + T.floordiv(rv0_rv1_fused_1, 3) * 7168 + ax2_4 * 128 + T.floormod(rv0_rv1_fused_1, 3) * 64 + ax3_2), T.uint8(0), dtype="uint8")), True)
    ...
    def run_model(input: T.handle, output: T.handle, fast_memory_0_var: T.handle, slow_memory_1_var: T.handle) -> None:
        ...
        slow_memory_1_buffer_var = T.match_buffer(slow_memory_1_var, [802816], dtype="uint8", strides=[1], elem_offset=1, align=16)
        # body
        T.attr("default", "device_id", 0)
        T.attr("default", "device_type", 1)
        sid_9_let: T.int8 = T.load("int8", slow_memory_1_buffer_var.data, 314646)
        sid_8_let: T.int8 = T.load("int8", slow_memory_1_buffer_var.data, 0)
        T.evaluate(T.call_extern("tvmgen_default_fused_cast_subtract", input, T.lookup_param("p0", dtype="handle"), sid_9_let, fast_memory_0_var, slow_memory_1_var, dtype="int32"))
        T.evaluate(T.call_extern("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast", sid_9_let, T.lookup_param("p1", dtype="handle"), T.lookup_param("p2", dtype="handle"), sid_8_let, fast_memory_0_var, slow_memory_1_var, dtype="int32"))
        T.evaluate(T.call_extern("tvmgen_default_fused_nn_max_pool2d_cast", sid_8_let, output, fast_memory_0_var, slow_memory_1_var, dtype="int32"))
    ...
    def tvmgen_default_fused_cast_subtract(placeholder_2: T.handle, placeholder_3: T.handle, T_subtract: T.handle, fast_memory_2_var: T.handle, slow_memory_3_var: T.handle) -> None:
        ...
        slow_memory_3_buffer_var = T.match_buffer(slow_memory_3_var, [802816], dtype="uint8", strides=[1], elem_offset=1, align=16)
        # body
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast(placeholder_62: T.handle, placeholder_63: T.handle, placeholder_64: T.handle, T_cast_20: T.handle, fast_memory_4_var: T.handle, slow_memory_5_var: T.handle) -> None:
        ...
        slow_memory_5_buffer_var = T.match_buffer(slow_memory_5_var, [802816], dtype="uint8", strides=[1], elem_offset=1, align=16)
        # body
        PaddedInput_7_let: T.int16 = T.load("int16", slow_memory_5_buffer_var.data, 0)
        ...
        for ax0_ax1_fused_ax2_fused_7 in T.serial(0, 12544):
            Conv2dOutput_7_let: T.int32 = T.load("int32", fast_memory_4_buffer_var.data, 0)
            for ff_3 in T.serial(0, 64):
                T.store(Conv2dOutput_7_let, ff_3, 0, True)
                for ry_2, rx_2, rc_7 in T.grid(7, 7, 3):
                    T.store(Conv2dOutput_7_let, ff_3, T.load("int32", Conv2dOutput_7_let, ff_3) + T.cast(T.load("int16", PaddedInput_7_let, T.floordiv(ax0_ax1_fused_ax2_fused_7, 112) * 1374 + ry_2 * 687 + T.floormod(ax0_ax1_fused_ax2_fused_7, 112) * 6 + rx_2 * 3 + rc_7), "int32") * T.cast(T.load("int16", placeholder_66.data, ry_2 * 1344 + rx_2 * 192 + rc_7 * 64 + ff_3), "int32"), True)
            for ax3_inner_7 in T.serial(0, 64):
...
class ResnetStructurePlanned:
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_add_clip_cast_cast_subtract_fixed_point_15934180698220515269_(placeholder_16: T.handle, placeholder_17: T.handle, placeholder_18: T.handle, T_add: T.handle, global_workspace_4_var: T.handle) -> None:
        ...
        # body
        PaddedInput_2_let: T.int16 = T.load("int16", global_workspace_4_buffer_var.data, 7200000)
        for i0_i1_fused_2, i2_2, i3_2 in T.grid(75, 75, 64):
        ...
        for ax0_ax1_fused_ax2_fused_2 in T.serial(0, 5625):
            Conv2dOutput_2_let: T.int32 = T.load("int32", global_workspace_4_buffer_var.data, 7920000)
            for ax3_outer_1 in T.serial(0, 4):
                for ff_2 in T.serial(0, 64):
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast_1(placeholder_10: T.handle, placeholder_11: T.handle, placeholder_12: T.handle, T_cast_4: T.handle, global_workspace_3_var: T.handle) -> None:
        ...
        # body
        PaddedInput_1_let: T.int16 = T.load("int16", global_workspace_3_buffer_var.data, 0)
        for i0_i1_fused_1, i2_1, i3_1 in T.grid(77, 77, 64):
        ...
        for ax0_ax1_fused_ax2_fused_1 in T.serial(0, 5625):
            Conv2dOutput_1_let: T.int32 = T.load("int32", global_workspace_3_buffer_var.data, 7200000)
            for ff_1 in T.serial(0, 64):
                T.store(Conv2dOutput_1_let, ff_1, 0, True)
                for ry, rx, rc_1 in T.grid(3, 3, 64):
                    T.store(Conv2dOutput_1_let, ff_1, T.load("int32", Conv2dOutput_1_let, ff_1) + T.cast(T.load("int16", PaddedInput_1_let, T.floordiv(ax0_ax1_fused_ax2_fused_1, 75) * 4928 + ry * 4928 + rx * 64 + T.floormod(ax0_ax1_fused_ax2_fused_1, 75) * 64 + rc_1), "int32") * T.cast(T.load("int16", placeholder_14.data, ry * 12288 + rx * 4096 + rc_1 * 64 + ff_1), "int32"), True)
            for ax3_inner_2 in T.serial(0, 64):
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast(placeholder_4: T.handle, placeholder_5: T.handle, placeholder_6: T.handle, T_cast_2: T.handle, global_workspace_2_var: T.handle) -> None:
        ...
        # body
        PaddedInput_let: T.int16 = T.load("int16", global_workspace_2_buffer_var.data, 6480000)
        for i0_i1_fused, i2, i3 in T.grid(75, 75, 64):
            T.store(PaddedInput_let, i0_i1_fused * 4800 + i2 * 64 + i3, T.load("int16", placeholder_7.data, i0_i1_fused * 4800 + i2 * 64 + i3), True)
        for ax0_ax1_fused_ax2_fused in T.serial(0, 5625):
            Conv2dOutput_let: T.int32 = T.load("int32", global_workspace_2_buffer_var.data, 7200000)
            for ff in T.serial(0, 64):
    ...
    def run_model(input: T.handle, output: T.handle, global_workspace_0_var: T.handle) -> None:
        ...
        T.attr("default", "device_id", 0)
        T.attr("default", "device_type", 1)
        sid_2_let: T.int8 = T.load("int8", global_workspace_0_buffer_var.data, 5760000)
        sid_6_let: T.int8 = T.load("int8", global_workspace_0_buffer_var.data, 0)
        sid_7_let: T.int8 = T.load("int8", global_workspace_0_buffer_var.data, 6480000)
        sid_8_let: T.int8 = T.load("int8", global_workspace_0_buffer_var.data, 6480000)
        T.evaluate(T.call_extern("tvmgen_default_fused_cast_subtract_fixed_point_multiply_add_clip_cast_cast", input, T.lookup_param("p0", dtype="handle"), sid_2_let, global_workspace_0_var, dtype="int32"))
        T.evaluate(T.call_extern("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast", sid_2_let, T.lookup_param("p3", dtype="handle"), T.lookup_param("p4", dtype="handle"), sid_8_let, global_workspace_0_var, dtype="int32"))
        T.evaluate(T.call_extern("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast_1", sid_8_let, T.lookup_param("p5", dtype="handle"), T.lookup_param("p6", dtype="handle"), sid_7_let, global_workspace_0_var, dtype="int32"))
        T.evaluate(T.call_extern("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_add_clip_cast_cast_subtract_fixed_point_15934180698220515269_", sid_7_let, T.lookup_param("p7", dtype="handle"), T.lookup_param("p8", dtype="handle"), sid_6_let, global_workspace_0_var, dtype="int32"))
        T.evaluate(T.call_extern("tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_add_clip_cast_cast_subtract_fixed_point_4200876283395191415_", sid_2_let, T.lookup_param("p1", dtype="handle"), T.lookup_param("p2", dtype="handle"), sid_6_let, output, global_workspace_0_var, dtype="int32"))
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_add_clip_cast_cast_subtract_fixed_point_4200876283395191415_(placeholder_22: T.handle, placeholder_23: T.handle, placeholder_24: T.handle, placeholder_25: T.handle, T_cast_6: T.handle, global_workspace_5_var: T.handle) -> None:
        ...
        # body
        PaddedInput_3_let: T.int16 = T.load("int16", global_workspace_5_buffer_var.data, 6480000)
        for i0_i1_fused_3, i2_3, i3_3 in T.grid(75, 75, 64):
        ...
        for ax0_ax1_fused_ax2_fused_3 in T.serial(0, 5625):
            Conv2dOutput_3_let: T.int32 = T.load("int32", global_workspace_5_buffer_var.data, 7200000)
            for ax3_outer_2 in T.serial(0, 4):
                for ff_3 in T.serial(0, 64):
