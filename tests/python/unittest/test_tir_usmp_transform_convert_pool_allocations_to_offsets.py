    ...
    def tvmgen_default_fused_cast_subtract(placeholder_2: T.handle, placeholder_3: T.handle, T_subtract: T.handle) -> None:
        ...
        for ax0_ax1_fused_1 in T.serial(0, 224):
            for ax2_1, ax3_inner_1 in T.grid(224, 3):
                T.store(T_subtract_1.data, (((ax0_ax1_fused_1*672) + (ax2_1*3)) + ax3_inner_1), (T.cast(placeholder_4[(((ax0_ax1_fused_1*672) + (ax2_1*3)) + ax3_inner_1)], "int16") - placeholder_5.data[0]), True)
...
class LinearStructurePlanned:
    ...
    def run_model(input: T.handle, fast_memory_0_var: T.handle, slow_memory_1_var: T.handle,  output: T.handle) -> None:
        ...
        T.attr("default", "device_id", 0)
        T.attr("default", "device_type", 1)
        sid_9_let: T.handle = T.address_of(slow_memory_1_buffer_var.data[1117472], dtype="handle")
        sid_8_let: T.handle = T.address_of(slow_memory_1_buffer_var.data[0], dtype="handle")
    ...
    def tvmgen_default_fused_nn_max_pool2d_cast(placeholder_28: T.handle, T_cast_6: T.handle, fast_memory_6_var: T.handle, slow_memory_7_var: T.handle) -> None:
        ...
        # body
        tensor_2_let: T.handle = T.address_of(fast_memory_6_buffer_var.data[0], dtype="handle")
        for ax0_ax1_fused_4, ax2_4 in T.grid(56, 56):
            for ax3_init in T.serial(0, 64):
                T.store(tensor_2_let, ax0_ax1_fused_4 * 3584 + ax2_4 * 64 + ax3_init, T.uint8(0), True)
            for rv0_rv1_fused_1, ax3_2 in T.grid(9, 64):
                T.store(tensor_2_let, ax0_ax1_fused_4 * 3584 + ax2_4 * 64 + ax3_2, T.max(tensor_2_let[ax0_ax1_fused_4 * 3584 + ax2_4 * 64 + ax3_2], T.if_then_else(ax0_ax1_fused_4 * 2 + rv0_rv1_fused_1 // 3 < 112 and ax2_4 * 2 + rv0_rv1_fused_1 % 3 < 112, placeholder_29.data[ax0_ax1_fused_4 * 14336 + rv0_rv1_fused_1 // 3 * 7168 + ax2_4 * 128 + rv0_rv1_fused_1 % 3 * 64 + ax3_2], T.uint8(0), dtype="uint8")), True)
        for ax0_ax1_fused_5, ax2_5, ax3_3 in T.grid(56, 56, 64):
            T.store(T_cast_7.data, ax0_ax1_fused_5 * 3584 + ax2_5 * 64 + ax3_3, T.cast(tensor_2_let[ax0_ax1_fused_5 * 3584 + ax2_5 * 64 + ax3_3], "int16"), True)
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast(placeholder_62: T.handle, placeholder_63: T.handle, placeholder_64: T.handle, T_cast_20: T.handle, fast_memory_4_var: T.handle, slow_memory_5_var: T.handle) -> None:
        ...
        # body
        PaddedInput_7_let: T.handle = T.address_of(slow_memory_5_buffer_var.data[802816], dtype="handle")
        for i0_i1_fused_7, i2_7, i3_7 in T.grid(229, 229, 3):
            T.store(PaddedInput_7_let, i0_i1_fused_7 * 687 + i2_7 * 3 + i3_7, T.if_then_else(2 <= i0_i1_fused_7 and i0_i1_fused_7 < 226 and 2 <= i2_7 and i2_7 < 226, placeholder_65.data[i0_i1_fused_7 * 672 + i2_7 * 3 + i3_7 - 1350], T.int16(0), dtype="int16"), True)
        for ax0_ax1_fused_ax2_fused_7 in T.serial(0, 12544):
            Conv2dOutput_7_let: T.handle = T.address_of(fast_memory_4_buffer_var.data[0], dtype="handle")
            for ff_3 in T.serial(0, 64):
                T.store(Conv2dOutput_7_let, ff_3, 0, True)
                for ry_2, rx_2, rc_7 in T.grid(7, 7, 3):
                    T.store(Conv2dOutput_7_let, ff_3, Conv2dOutput_7_let[ff_3] + T.cast(PaddedInput_7_let[ax0_ax1_fused_ax2_fused_7 // 112 * 1374 + ry_2 * 687 + ax0_ax1_fused_ax2_fused_7 % 112 * 6 + rx_2 * 3 + rc_7], "int32") * T.cast(placeholder_66.data[ry_2 * 1344 + rx_2 * 192 + rc_7 * 64 + ff_3], "int32"), True)
            for ax3_inner_7 in T.serial(0, 64):
                T.store(T_cast_21.data, ax0_ax1_fused_ax2_fused_7 * 64 + ax3_inner_7, T.cast(T.max(T.min(T.q_multiply_shift(Conv2dOutput_7_let[ax3_inner_7] + placeholder_67.data[ax3_inner_7], 1939887962, 31, -9, dtype="int32"), 255), 0), "uint8"), True)
# fmt: on
...
class ResnetStructurePlanned:
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_add_clip_cast_cast_subtract_fixed_point_4200876283395191415_(placeholder_22: T.handle, placeholder_23: T.handle, placeholder_24: T.handle, placeholder_25: T.handle, T_cast_6: T.handle, global_workspace_5_var: T.handle) -> None:
        ...
        # body
        PaddedInput_3_let: T.handle = T.address_of(global_workspace_5_buffer_var.data[6480000], dtype="handle")
        for i0_i1_fused_3, i2_3, i3_3 in T.grid(75, 75, 64):
            T.store(PaddedInput_3_let, i0_i1_fused_3 * 4800 + i2_3 * 64 + i3_3, placeholder_29.data[i0_i1_fused_3 * 4800 + i2_3 * 64 + i3_3], True)
        for ax0_ax1_fused_ax2_fused_3 in T.serial(0, 5625):
            Conv2dOutput_3_let: T.handle = T.address_of(global_workspace_5_buffer_var.data[7200000], dtype="handle")
            for ax3_outer_2 in T.serial(0, 4):
                for ff_3 in T.serial(0, 64):
                    T.store(Conv2dOutput_3_let, ff_3, 0, True)
                    for rc_3 in T.serial(0, 64):
                        T.store(Conv2dOutput_3_let, ff_3, Conv2dOutput_3_let[ff_3] + T.cast(PaddedInput_3_let[ax0_ax1_fused_ax2_fused_3 * 64 + rc_3], "int32") * T.cast(placeholder_27.data[rc_3 * 256 + ax3_outer_2 * 64 + ff_3], "int32"), True)
                for ax3_inner_4 in T.serial(0, 64):
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_add_clip_cast_cast_subtract_fixed_point_15934180698220515269_(placeholder_16: T.handle, placeholder_17: T.handle, placeholder_18: T.handle, T_add: T.handle, global_workspace_4_var: T.handle) -> None:
        ...
        # body
        PaddedInput_2_let: T.handle = T.address_of(global_workspace_4_buffer_var.data[7200000], dtype="handle")
        for i0_i1_fused_2, i2_2, i3_2 in T.grid(75, 75, 64):
            T.store(PaddedInput_2_let, i0_i1_fused_2 * 4800 + i2_2 * 64 + i3_2, placeholder_19.data[i0_i1_fused_2 * 4800 + i2_2 * 64 + i3_2], True)
        for ax0_ax1_fused_ax2_fused_2 in T.serial(0, 5625):
            Conv2dOutput_2_let: T.handle = T.address_of(global_workspace_4_buffer_var.data[7920000], dtype="handle")
            for ax3_outer_1 in T.serial(0, 4):
                for ff_2 in T.serial(0, 64):
                    T.store(Conv2dOutput_2_let, ff_2, 0, True)
                    for rc_2 in T.serial(0, 64):
                        T.store(Conv2dOutput_2_let, ff_2, Conv2dOutput_2_let[ff_2] + T.cast(PaddedInput_2_let[ax0_ax1_fused_ax2_fused_2 * 64 + rc_2], "int32") * T.cast(placeholder_20.data[rc_2 * 256 + ax3_outer_1 * 64 + ff_2], "int32"), True)
                for ax3_inner_3 in T.serial(0, 64):
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast(placeholder_4: T.handle, placeholder_5: T.handle, placeholder_6: T.handle, T_cast_2: T.handle, global_workspace_2_var: T.handle) -> None:
        ...
        # body
        PaddedInput_let: T.handle = T.address_of(global_workspace_2_buffer_var.data[7200000], dtype="handle")
        for i0_i1_fused, i2, i3 in T.grid(75, 75, 64):
            T.store(PaddedInput_let, i0_i1_fused * 4800 + i2 * 64 + i3, placeholder_7.data[i0_i1_fused * 4800 + i2 * 64 + i3], True)
        for ax0_ax1_fused_ax2_fused in T.serial(0, 5625):
            Conv2dOutput_let: T.handle = T.address_of(global_workspace_2_buffer_var.data[7920000], dtype="handle")
            for ff in T.serial(0, 64):
                T.store(Conv2dOutput_let, ff, 0, True)
                for rc in T.serial(0, 64):
                    T.store(Conv2dOutput_let, ff, Conv2dOutput_let[ff] + T.cast(PaddedInput_let[ax0_ax1_fused_ax2_fused * 64 + rc], "int32") * T.cast(placeholder_8.data[rc * 64 + ff], "int32"), True)
            for ax3_inner_1 in T.serial(0, 64):
                T.store(T_cast_3.data, ax0_ax1_fused_ax2_fused * 64 + ax3_inner_1, T.cast(T.cast(T.max(T.min(T.q_multiply_shift(Conv2dOutput_let[ax3_inner_1] + placeholder_9.data[ax3_inner_1], 1843106743, 31, -6, dtype="int32"), 255), 0), "uint8"), "int16"), True)
    ...
    def tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_clip_cast_cast_1(placeholder_10: T.handle, placeholder_11: T.handle, placeholder_12: T.handle, T_cast_4: T.handle, global_workspace_3_var: T.handle) -> None:
        ...
        # body
        PaddedInput_1_let: T.handle = T.address_of(global_workspace_3_buffer_var.data[0], dtype="handle")
        for i0_i1_fused_1, i2_1, i3_1 in T.grid(77, 77, 64):
            T.store(PaddedInput_1_let, i0_i1_fused_1 * 4928 + i2_1 * 64 + i3_1, T.if_then_else(1 <= i0_i1_fused_1 and i0_i1_fused_1 < 76 and 1 <= i2_1 and i2_1 < 76, placeholder_13.data[i0_i1_fused_1 * 4800 + i2_1 * 64 + i3_1 - 4864], T.int16(0), dtype="int16"), True)
        for ax0_ax1_fused_ax2_fused_1 in T.serial(0, 5625):
            Conv2dOutput_1_let: T.handle = T.address_of(global_workspace_3_buffer_var.data[7200000], dtype="handle")
            for ff_1 in T.serial(0, 64):
                T.store(Conv2dOutput_1_let, ff_1, 0, True)
                for ry, rx, rc_1 in T.grid(3, 3, 64):
                    T.store(Conv2dOutput_1_let, ff_1, Conv2dOutput_1_let[ff_1] + T.cast(PaddedInput_1_let[ax0_ax1_fused_ax2_fused_1 // 75 * 4928 + ry * 4928 + rx * 64 + ax0_ax1_fused_ax2_fused_1 % 75 * 64 + rc_1], "int32") * T.cast(placeholder_14.data[ry * 12288 + rx * 4096 + rc_1 * 64 + ff_1], "int32"), True)
            for ax3_inner_2 in T.serial(0, 64):
                T.store(T_cast_5.data, ax0_ax1_fused_ax2_fused_1 * 64 + ax3_inner_2, T.cast(T.cast(T.max(T.min(T.q_multiply_shift(Conv2dOutput_1_let[ax3_inner_2] + placeholder_15.data[ax3_inner_2], 1608879842, 31, -7, dtype="int32"), 255), 0), "uint8"), "int16"), True)
    ...
    def run_model(input: T.handle, global_workspace_0_var: T.handle, output: T.handle) -> None:
        ...
        T.attr("default", "device_id", 0)
        T.attr("default", "device_type", 1)
        sid_2_let: T.handle = T.address_of(global_workspace_0_buffer_var.data[5760000], dtype="handle")
        sid_6_let: T.handle = T.address_of(global_workspace_0_buffer_var.data[0], dtype="handle")
        sid_7_let: T.handle = T.address_of(global_workspace_0_buffer_var.data[6480000], dtype="handle")
        sid_8_let: T.handle = T.address_of(global_workspace_0_buffer_var.data[6480000], dtype="handle")
