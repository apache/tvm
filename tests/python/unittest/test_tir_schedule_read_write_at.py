...
def test_read_at_global_to_shared_a():
    ...
    assert_structural_equal_gs(sch.mod["main"], cuda_matmul_read_at_a)
...
def test_read_at_global_to_shared_ab():
    ...
    assert_structural_equal_gs(sch.mod["main"], cuda_matmul_read_at_ab)
...
def test_read_at_local_to_shared_c():
    ...
    assert_structural_equal_gs(sch.mod["main"], cuda_matmul_write_at_c)
