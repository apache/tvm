...
def test_set_axis_separator(argument_style):
    ...
    assert_structural_equal_gs(element_wise_set_axis_separator, s.mod["main"])
...
def test_set_axis_separator_input_buffer(argument_style):
    ...
    assert_structural_equal_gs(element_wise_set_axis_separator_input_buffer, s.mod["main"])
    verify_trace_roundtrip(sch=s, mod=func)
...
def test_set_axis_separator_subregion(argument_style):
    ...
    assert_structural_equal_gs(element_wise_subregion_match_set_axis_separator, s.mod["main"])
    verify_trace_roundtrip(sch=s, mod=func)
