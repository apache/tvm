...
from tvm.testing.auto_scheduler import matmul_auto_scheduler_test, softmax_nm_auto_scheduler_test
...
@tvm.testing.requires_llvm
def test_task_scheduler_family():
    tasks = []
    for n in [2, 4]:
        tasks.append(
            auto_scheduler.SearchTask(
