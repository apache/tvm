...
def test_reduction_decompose0(use_block_name):
    ...
    assert_structural_equal_gs(matmul_decompose0, s.mod["main"])
...
def test_reduction_decompose1(use_block_name):
    ...
    assert_structural_equal_gs(matmul_decompose1, s.mod["main"])
...
def test_reduction_decompose2():
    ...
    assert_structural_equal_gs(matmul_decompose2, s.mod["main"])
    verify_trace_roundtrip(s, mod=matmul)
...
def test_reduction_decompose4():
    ...
    assert_structural_equal_gs(matmul_decompose4, s.mod["main"])
    verify_trace_roundtrip(s, mod=matmul)
...
def test_reduction_decompose_with_annotation():
    ...
    i, j, k = s.get_loops(C)
    s.decompose_reduction(C, i)
    assert_structural_equal_gs(matmul_decompose_with_annotation, s.mod["main"])
...
def test_reduction_decompose_with_different_for_kind():
    ...
    assert_structural_equal_gs(s.mod["main"], colsum_decompose_with_vectorization)
...
def test_decompose_reduction_nested_block():
    ...
    assert_structural_equal_gs(decomposed_nested_block, sch.mod["main"])
