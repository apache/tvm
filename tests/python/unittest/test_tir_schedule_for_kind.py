...
def test_parallel():
    ...
    s.parallel(i)
    assert_structural_equal_gs(s.mod["main"], element_wise_parallelized)
...
def test_parallel_predicate():
    ...
    s.parallel(j)
    assert_structural_equal_gs(s.mod["main"], element_wise_split_predicate_parallelized)
...
def test_vectorize():
    ...
    s.vectorize(j1i)
    assert_structural_equal_gs(s.mod["main"], element_wise_compute_at_split_vectorized)
...
def test_vectorize_predicate():
    ...
    s.vectorize(i)
    assert_structural_equal_gs(s.mod["main"], element_wise_split_predicate_vectorized)
    verify_trace_roundtrip(s, mod=element_wise_split_predicate)
...
def test_unroll():
    ...
    i, _ = s.get_loops(s.get_block("B"))
    s.unroll(i)
    assert_structural_equal_gs(s.mod["main"], rowsum_unrolled)
...
def test_bind1():
    ...
    assert_structural_equal_gs(s.mod["main"], element_wise_i_bound)
    verify_trace_roundtrip(s, mod=element_wise)
...
def test_bind2():
    ...
    assert_structural_equal_gs(s.mod["main"], element_wise_compute_at_split_j0_j1o_bound)
    verify_trace_roundtrip(s, mod=element_wise_compute_at_split)
...
def test_bind_cross_thread_reduction():
    ...
    assert_structural_equal_gs(s.mod["main"], rowsum_cross_thread_reduction)
    verify_trace_roundtrip(s, mod=rowsum)
...
def test_block_inside_init():
    ...
    s.bind(i, "threadIdx.x")
    assert_structural_equal_gs(s.mod["main"], thread_bound_block_inside_init)
...
def test_vectorize_after_decompose():
    ...
    s.vectorize(jj)
    assert_structural_equal_gs(s.mod["main"], decomposed_gemm_after_vectorize)
...
def test_nested_block_bind():
    ...
    s.bind(j, "blockIdx.x")
    assert_structural_equal_gs(s.mod["main"], thread_bound_nested_block)
...
def test_nexted_block_bind_after_cache_read():
    ...
    assert_structural_equal_gs(s.mod["main"], thread_bound_nested_block_after_cache_read)
...
def test_vectorize_init():
    ...
    s.vectorize(jj_0)
    assert_structural_equal_gs(s.mod["main"], decomposed_gemm_parallelize_init)
    verify_trace_roundtrip(s, mod=decomposed_gemm)
...
def test_scatter_parallelize():
    ...
    s.parallel(i_0)
    s.parallel(i_1)
    assert_structural_equal_gs(s.mod["main"], scatter_compute_parallelize)
