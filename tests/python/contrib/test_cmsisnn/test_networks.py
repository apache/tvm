...
def test_cnn_small(test_runner):
    ...
    # download the model
    base_url = "https://github.com/ARM-software/ML-zoo/raw/48a22ee22325d15d2371a6df24eb7d67e21dcc97/models/keyword_spotting/cnn_small/tflite_int8"  # pylint: disable=line-too-long
