...
class AllOperatorsWithWeights:
    ...
    def main() -> None:
        ...
        p2 = T.decl_buffer([112], "uint8", scope="global")
        p3 = T.decl_buffer([112], "uint8", scope="global")
        p4 = T.decl_buffer([32], "uint8", scope="global")
        p5 = T.decl_buffer([32], "uint8", scope="global")
        p6 = T.decl_buffer([32], "uint8", scope="global")
        p7 = T.decl_buffer([112], "uint8", scope="global")
        p8 = T.decl_buffer([32], "uint8", scope="global")
...
class AllOperatorsWithoutWeights:
    ...
    def main() -> None:
        ...
        # body
        p1 = T.decl_buffer([96], "int8", scope="global")
...
class OperatorsWithAndWithoutWeights:
    ...
    def main() -> None:
        ...
        buffer5 = T.buffer_decl([32], "uint8")
        # body
        p1 = T.decl_buffer([390336], "int8", scope="global")
        p2 = T.decl_buffer([80], "uint8", scope="global")
        p3 = T.decl_buffer([64], "uint8", scope="global")
        p4 = T.decl_buffer([390336], "int8", scope="global")
        p5 = T.decl_buffer([96], "uint8", scope="global")
        p6 = T.decl_buffer([32], "uint8", scope="global")
...
class CopyToBufferWithLocalScope:
    ...
    def main() -> None:
        ...
        # body
        p1 = T.decl_buffer([48], "uint8", scope="global")
        p2 = T.decl_buffer([48], "uint8", scope="global")
        p3 = T.decl_buffer([256], "int8", scope="local")
        p4 = T.decl_buffer([256], "int8", scope="global")
        p5 = T.decl_buffer([16], "uint8", scope="global")
        p6 = T.decl_buffer([48], "uint8", scope="global")
...
def test_reordering_based_on_cycles():
    ...
    class ModuleBefore:
        ...
        def main(placeholder: T.Buffer[97156, "int8"], placeholder_encoded: T.Buffer[208, "uint8"], placeholder_encoded_1: T.Buffer[112, "uint8"], placeholder_encoded_2: T.Buffer[96, "uint8"], placeholder_encoded_3: T.Buffer[112, "uint8"], ethosu_write: T.Buffer[43672, "int8"]) -> None:
            ...
            nn_5 = T.var("int32")
            # body
            placeholder_d_global = T.decl_buffer([208], "uint8", scope="global")
            placeholder_d_global_1 = T.decl_buffer([112], "uint8", scope="global")
            placeholder_d_global_2 = T.decl_buffer([96], "uint8", scope="global")
            placeholder_d_global_3 = T.decl_buffer([112], "uint8", scope="global")
            ethosu_write_1 = T.decl_buffer([195168], "int8", scope="global")
            ethosu_write_2 = T.decl_buffer([184800], "int8", scope="global")
            ethosu_write_3 = T.decl_buffer([174688], "int8", scope="global")
            ethosu_write_4 = T.decl_buffer([174688], "int8", scope="global")
            ethosu_write_5 = T.decl_buffer([174688], "int8", scope="global")
...
def test_reordering_based_on_cycles_luts_present():
    ...
    class ModuleBefore:
        ...
        def main(placeholder: T.Buffer[97156, "int8"], placeholder_encoded: T.Buffer[208, "uint8"], placeholder_encoded_1: T.Buffer[112, "uint8"], placeholder_1: T.Buffer[256, "int8"], placeholder_encoded_2: T.Buffer[96, "uint8"], placeholder_2: T.Buffer[256, "int8"], placeholder_3: T.Buffer[256, "int8"], ethosu_write: T.Buffer[46200, "int8"]) -> None:
            ...
            nn_5 = T.var("int32")
            # body
            placeholder_d_d_global = T.decl_buffer([208], "uint8", scope="global")
            placeholder_d_d_global_1 = T.decl_buffer([112], "uint8", scope="global")
            placeholder_d_global = T.decl_buffer([96], "uint8", scope="global")
            ethosu_write_1 = T.decl_buffer([195168], "int8", scope="global")
            placeholder_local = T.decl_buffer([256], "int8", scope="local")
            ethosu_write_2 = T.decl_buffer([184800], "int8", scope="global")
            ethosu_write_3 = T.decl_buffer([184800], "int8", scope="global")
            ethosu_write_4 = T.decl_buffer([184800], "int8", scope="global")
            placeholder_d_local = T.decl_buffer([256], "int8", scope="local")
            ethosu_write_5 = T.decl_buffer([184800], "int8", scope="global")
