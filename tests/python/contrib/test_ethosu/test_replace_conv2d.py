...
class Conv2dDoubleCascade1:
    ...
    def main(input_placeholder_5: T.Buffer((1, 8, 8, 3), "int8"), input_ethosu_write_1: T.Buffer((1, 8, 8, 8), "int8")) -> None:
        ...
        placeholder_5 =  T.decl_buffer([192], 'int8', data=input_placeholder_5.data)
        ethosu_write_1 = T.decl_buffer([512], 'int8', data=input_ethosu_write_1.data)

        ethosu_write_2_data = T.allocate([1024], "int8", "global", annotations={"disable_lower_builtin": True})
        ethosu_write_2 = T.decl_buffer([1024], "int8", data=ethosu_write_2_data)
...
class Conv2dDoubleCascade2:
    ...
    def main(input_placeholder_5: T.Buffer((1, 8, 8, 3), "int8"), input_ethosu_write_1: T.Buffer((1, 8, 8, 8), "int8")) -> None:
        ...
        ethosu_write_2 = T.decl_buffer([1536], "int8", data=ethosu_write_2_data)
...
class Conv2dDoubleCascade3:
    ...
    def main(input_placeholder_5: T.Buffer((1, 16, 16, 3), "int8"), input_ethosu_write_1: T.Buffer((1, 20, 4, 8), "int8")) -> None:
        ...
        placeholder_5 = T.decl_buffer([768], 'int8', data=input_placeholder_5.data)
        ethosu_write_1 = T.decl_buffer([640], 'int8', data=input_ethosu_write_1.data)

        # body
        ethosu_write_2_data = T.allocate([2560], "int8", "global", annotations={"disable_lower_builtin": True})
        ethosu_write_2 = T.decl_buffer([2560], "int8", data=ethosu_write_2_data)
...
class Conv2dDoubleCascade4:
    ...
    def main(input_placeholder_5: T.Buffer((1, 8, 1, 8, 16), "int8"), input_ethosu_write_1: T.Buffer((1, 8, 2, 8, 16), "int8")) -> None:
        ...
        placeholder_5 = T.decl_buffer([1024], 'int8', data=input_placeholder_5.data)
        ethosu_write_1 = T.decl_buffer([2048], 'int8', data=input_ethosu_write_1.data)
        # body
        ethosu_write_2_data = T.allocate([2304], "int8", "global", annotations={"disable_lower_builtin": True})
        ethosu_write_2 = T.decl_buffer((2304,), "int8", data=ethosu_write_2_data)
...
class Conv2dDoubleCascade5:
    ...
    def main(input_placeholder: T.Buffer((1, 8, 8, 3), "int8"), input_ethosu_write: T.Buffer((1, 32, 32, 8), "int8")) -> None:
        ...
        placeholder = T.decl_buffer([192], 'int8', data=input_placeholder.data)
        ethosu_write = T.decl_buffer([8192], 'int8', data=input_ethosu_write.data)
        # body
...
class Conv2dDoubleCascade6:
    ...
    def main(input_placeholder: T.Buffer((1, 8, 1, 8, 16), "int8"), input_ethosu_write: T.Buffer((1, 32, 2, 32, 16), "int8")) -> None:
        ...
        placeholder = T.decl_buffer([1024], 'int8', data=input_placeholder.data)
        ethosu_write = T.decl_buffer([32768], 'int8', data=input_ethosu_write.data)
        # body
        ethosu_write_1_data = T.allocate([12288], "int8", "global", annotations={"disable_lower_builtin":True})
        ethosu_write_1 = T.decl_buffer([12288], "int8", data=ethosu_write_1_data)
...
class Conv2dInlineCopy1:
    ...
    def main(input_placeholder_3: T.Buffer((1, 10, 12, 8), "int8"), input_ethosu_write_1: T.Buffer((1, 8, 8, 16), "int8")) -> None:
        ...
        placeholder_3 = T.decl_buffer([960], 'int8', data=input_placeholder_3.data)
        ethosu_write_1 = T.decl_buffer([1024], 'int8', data=input_ethosu_write_1.data)
        # body
...
class Conv2dInlineCopy2:
    ...
    def main(input_placeholder_3: T.Buffer((1, 7, 9, 5), "int8"), input_ethosu_write_1: T.Buffer((1, 3, 5, 16), "int8")) -> None:
        ...
        placeholder_3 = T.decl_buffer([315], 'int8', data=input_placeholder_3.data)
        ethosu_write_1 = T.decl_buffer([240], 'int8', data=input_ethosu_write_1.data)
        # body
...
class Conv2dInlineReshape1:
    ...
    def main(input_placeholder_3: T.Buffer((4, 6, 8, 1), "int8"), input_ethosu_write_1: T.Buffer((1, 8, 6, 16), "int8")) -> None:
        ...
        placeholder_3 = T.decl_buffer([192], 'int8', data=input_placeholder_3.data)
        ethosu_write_1 = T.decl_buffer([768], 'int8', data=input_ethosu_write_1.data)
        # body
