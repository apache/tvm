...
def test_relay_reshape_legalize(ifm_shape, new_shape):
    ...
    mod["tvmgen_default_ethosu_main_0"] = dataflow_pattern.rewrite(
        legalize.ReshapeRewriter(), mod["tvmgen_default_ethosu_main_0"]
    )
    mod["tvmgen_default_ethosu_main_0"] = dataflow_pattern.rewrite(
        legalize.NoOpRewriter(), mod["tvmgen_default_ethosu_main_0"]
    )
    mod = relay.transform.InferType()(mod)

    ext_func = mod["tvmgen_default_ethosu_main_0"]
...
def test_relay_strided_slice_legalize(ifm_shape, begin, end):
    ...
    mod["tvmgen_default_ethosu_main_0"] = dataflow_pattern.rewrite(
        legalize.StridedSliceRewriter(), mod["tvmgen_default_ethosu_main_0"]
    )
    mod["tvmgen_default_ethosu_main_0"] = dataflow_pattern.rewrite(
        legalize.NoOpRewriter(), mod["tvmgen_default_ethosu_main_0"]
    )
