...
def test_split_indices_legalize():
    ...
    mod_axis1["tvmgen_default_ethosu_main_0"] = rewrite(
        legalize.SplitRewriter(), mod_axis1["tvmgen_default_ethosu_main_0"]
    )
    ...
    mod_axis2["tvmgen_default_ethosu_main_0"] = rewrite(
        legalize.SplitRewriter(), mod_axis2["tvmgen_default_ethosu_main_0"]
    )
...
def test_ethosu_conv2d_legalize():
    ...
    for test_case in test_cases:
        ...
        mod["tvmgen_default_ethosu_main_0"] = rewrite(
