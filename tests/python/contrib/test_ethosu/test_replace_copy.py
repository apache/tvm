...
class ReferenceModule:
    ...
    def main(placeholder_3: T.Buffer[(8192,), "int8"], ethosu_write_1: T.Buffer[(2048,), "int8"]) -> None:
        ...
        placeholder_global = T.decl_buffer([384], "uint8", data=placeholder_global_data, scope="global")
...
class WeightStream:
    ...
    def main(placeholder_5: T.Buffer[(8192,), "int8"], ethosu_write_1: T.Buffer[(4096,), "int8"]) -> None:
        ...
        placeholder_d_global = T.decl_buffer([528], "uint8", data=placeholder_d_global_data, scope="global")
        placeholder_d_global_1_data = T.allocate([336], "uint8", "global", annotations={"disable_lower_builtin": True})
        placeholder_d_global_1 = T.decl_buffer([336], "uint8", data=placeholder_d_global_1_data, scope="global")
