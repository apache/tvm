...
class MultiEthosUConv2D:
    ...
    def main(placeholder_6: T.Buffer[(192,), "int8"], ethosu_conv2d_1: T.Buffer[(512,), "int8"]) -> None:
        ...
        ethosu_conv2d_3 = T.decl_buffer([2048], "uint8", scope="global")
...
class MultiEthosUCopy:
    ...
    def main(placeholder_3: T.Buffer[(8192,), "int8"], ethosu_conv2d_1: T.Buffer[(2048,), "int8"]) -> None:
        ...
        placeholder_4 = T.buffer_decl([1], "uint8")
        # body
        placeholder_global = T.decl_buffer([256], "uint8", scope="global")
        placeholder_d_global = T.decl_buffer([8], "int32", scope="global")
...
class WeightStreamOnly:
    ...
    def main(placeholder: T.Buffer[(8192,), "int8"], ethosu_write: T.Buffer[(2048,), "int8"]) -> None:
        ...
        placeholder_global = T.decl_buffer([128], "uint8", data=placeholder_global_data, scope="global")
        placeholder_d_global_data = T.allocate([32], "uint8", "global", annotations={"disable_lower_builtin":True})
        placeholder_d_global = T.decl_buffer([32], "uint8", data=placeholder_d_global_data, scope="global")
...
class MixedRead:
    ...
    def main(placeholder: T.Buffer[(8192,), "int8"], ethosu_write: T.Buffer[(2048,), "int8"]) -> None:
        ...
        placeholder_global = T.buffer_decl([80], "uint8", data=placeholder_global_data, scope="global")
        placeholder_d_global_data = T.allocate([32], "uint8", "global", annotations={"disable_lower_builtin":True})
    ...
    def main(placeholder_4: T.Buffer[(2048,), "int8"], ethosu_write_1: T.Buffer[(16,), "int8"]) -> None:
        ...
        T.func_attr({"from_legacy_te_schedule": True,
                     ...
                     "constants": {buffer.name: buffer,
                                   ...
                                   buffer_2.name: buffer_2}})
        # body
        placeholder_global = T.decl_buffer([272], "uint8", scope="global")
        placeholder_d_global = T.decl_buffer([160], "uint8", scope="global")
        ethosu_write_2 = T.decl_buffer([16], "int16", scope="global")
        placeholder_d_global_1 = T.decl_buffer([1], "int16", scope="global")
