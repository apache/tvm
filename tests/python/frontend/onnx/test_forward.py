...
def test_maxunpool():
    def verify_maxunpool(data, indices, kernel_shape, output_shape=None, pads=None, strides=None):
        input_names = ["xT", "xI"]
        input_info = [helper.make_tensor_value_info("xT", TensorProto.FLOAT, list(data.shape)),
        ...
        if output_shape is not None:
            ...
            input_info.append(helper.make_tensor_value_info("output_shape", TensorProto.INT64, list(output_shape.shape)))
