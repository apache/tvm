...
TEST(TextureCopy, ViewBufferAsImage) {
  ...
  auto opencl_img_obj =
      opencl_buf_obj.CreateView(same_shape, {kDLFloat, 32, 1}, String("global.texture"));
...
TEST(TextureCopy, ViewImageAsBuffer) {
  ...
  auto opencl_buf_obj = opencl_img_obj.CreateView(same_shape, {kDLFloat, 32, 1}, String("global"));
...
TEST(TextureCopy, ViewImageAsImage) {
  ...
  auto opencl_img_obj_2 =
      opencl_img_obj_1.CreateView(same_shape, {kDLFloat, 32, 1}, String("global.texture"));
