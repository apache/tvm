...
def test_add_uint(temp_dir, board, west_cmd, tvm_debug, use_fvp):
    ...
    with _make_add_sess(temp_dir, model, board, west_cmd, build_config, use_fvp) as sess:
        test_basic_add(sess)
...
@tvm.testing.requires_micro
@pytest.mark.skip_boards(["mps2_an521"])
def test_add_float(temp_dir, board, west_cmd, tvm_debug, use_fvp):
    """Test compiling the on-device runtime."""
    model = test_utils.ZEPHYR_BOARDS[board]
...
@tvm.testing.requires_micro
@pytest.mark.skip_boards(["mps2_an521"])
def test_platform_timer(temp_dir, board, west_cmd, tvm_debug, use_fvp):
    """Test compiling the on-device runtime."""
...
@tvm.testing.requires_micro
@pytest.mark.skip_boards(["mps2_an521"])
def test_onnx(temp_dir, board, west_cmd, tvm_debug, use_fvp):
...
@tvm.testing.requires_micro
@pytest.mark.skip_boards(["mps2_an521"])
def test_byoc_microtvm(temp_dir, board, west_cmd, tvm_debug, use_fvp):
...
@tvm.testing.requires_micro
@pytest.mark.skip_boards(["mps2_an521"])
def test_rpc_large_array(temp_dir, board, west_cmd, tvm_debug, shape, use_fvp):
...
@tvm.testing.requires_micro
def test_autotune_conv2d(temp_dir, board, west_cmd, tvm_debug, use_fvp):
...
@tvm.testing.requires_micro
def test_schedule_build_with_cmsis_dependency(temp_dir, board, west_cmd, tvm_debug, use_fvp):
