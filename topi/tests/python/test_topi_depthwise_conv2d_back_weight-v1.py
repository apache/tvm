...
def depthwise_conv2d_with_workload_nhwc(batch, in_channel, in_height, channel_multiplier, filter_height, stride_h, padding_h):
    ...
    def check_device(device):
        ...
        np.testing.assert_allclose(output_tf, weight_backprop_tvm.asnumpy(), rtol=1e-4)
        print("success")
...
def test_depthwise_conv2d():
    ...
    depthwise_conv2d_with_workload_nhwc(32, 64, 112, 1, 3, 1, 1)

    #depthwise_conv2d_with_workload_nhwc(32, 728, 64, 1, 3, 1, 1)
    #depthwise_conv2d_with_workload_nhwc(64, 728, 32, 1, 3, 1, 1)
    #depthwise_conv2d_with_workload_nhwc(32, 256, 64, 2, 5, 1, 2) # stride should be 2
    #depthwise_conv2d_with_workload_nhwc(64, 256, 32, 2, 5, 1, 2) # stride should be 2
