...
def _get_schedule_conv(wkl):
    ...
    _SCHEDULES_AVX = [
        # workloads of resnet18_v1 on imagenet
        AVXConvCommonFwd(3, fp32_vec_len, 28, False, -1),
        AVXConvCommonFwd(fp32_vec_len, fp32_vec_len, 28, False, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 1, 28, -1),
        AVXConvCommonFwd(fp32_vec_len, fp32_vec_len, 28, False, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 1, 28, -1),
        AVXConvCommonFwd(fp32_vec_len, fp32_vec_len, 28, False, -1),
        AVXConvCommonFwd(fp32_vec_len, fp32_vec_len, 14, False, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 14, -1),
        AVXConvCommonFwd(fp32_vec_len, fp32_vec_len, 14, True, -1),
        AVXConvCommonFwd(fp32_vec_len, fp32_vec_len, 7, True, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 1, 7, -1),
        AVXConvCommonFwd(fp32_vec_len, fp32_vec_len, 7, True, -1),
        # workloads of resnet34_v1 on imagenet, no extra workload required
        # workloads of resnet50_v1 on imagenet
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 28, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 28, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 28, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 28, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 28, -1),
        ...
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 14, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 14, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 7, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 7, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 7, -1),
        AVXConv1x1Fwd(fp32_vec_len, fp32_vec_len, 2, 7, -1),
        # workloads of resnet101_v1 on imagenet, no extra workload required
