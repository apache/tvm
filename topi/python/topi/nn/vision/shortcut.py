...
def shortcut(inp1, inp2):
    ...
    _, inp1_c, inp1_h, inp1_w = topi.util.get_const_tuple(inp1.shape)
    batch, inp2_c, inp2_h, inp2_w = topi.util.get_const_tuple(inp2.shape)
    ...
    if split_indices > 1:
        split_res = topi.transform.split(inp1, split_indices, 1)
        split_res[0] = out
