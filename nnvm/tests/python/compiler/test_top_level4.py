...
def test_reduce():
    ...
    verify_reduce((128, 24, 128, 24), np.mean, sym.mean, axis=(0, 1), keepdims=False)
    verify_reduce((128, 24, 128, 24), np.mean, sym.mean, axis=(0, 2), keepdims=False)
    verify_reduce((128, 24, 128, 24), np.mean, sym.mean, axis=(0, 1), keepdims=True)
    verify_reduce((128, 24, 128, 24), np.mean, sym.mean, axis=(0, 2), keepdims=True)
    verify_reduce((128, 24, 128, 24), np.mean, sym.mean, axis=None, keepdims=True)
    verify_reduce((128, 24, 128), np.mean, sym.mean, axis=None, keepdims=False)
