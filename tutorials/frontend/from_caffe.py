...
To get started, Caffe package needs to be installed or you can use the provided
API in ${TVM_ROOT}/python/tvm/relay/frontend/caffe_pb2.py

If you install Caffe, please refer to https://github.com/BVLC/caffe
...
proto_file_url = "https://github.com/BVLC/caffe/raw/master/models/bvlc_alexnet/deploy.prototxt"
