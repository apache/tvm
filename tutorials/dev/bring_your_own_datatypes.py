...
#//TODO(hypercubestart, gus): figure out 3rd party library
...
# Note that the type code, 150, is currently chosen manually by the programmer. 
# See `TVMTypeCode::kCustomBegin` in [include/tvm/runtime/c_runtime_api.h](https://github.com/apache/incubator-tvm/blob/master/include/tvm/runtime/data_type.h).
