...
optimizer1 = optim.Adam(param_list1, lr=args.lr/100, weight_decay=args.weight_decay)
optimizer2 = optim.Adam(param_list2, lr=args.lr, weight_decay=args.weight_decay)
...
#     train(epoch, model, train_loader, optimizer, criterion)    
    train_transfer(epoch, model, train_loader, optimizer1, optimizer2, criterion)
...
#     optimizer=exp_lr_scheduler(epoch, optimizer, strategy=args.lr_schedule, decay_eff=args.lr_decay, decayEpoch=args.lr_decay_epoch)
    optimizer1=exp_lr_scheduler(epoch, optimizer1, strategy=args.lr_schedule, decay_eff=args.lr_decay, decayEpoch=args.lr_decay_epoch)
    optimizer2=exp_lr_scheduler(epoch, optimizer2, strategy=args.lr_schedule, decay_eff=args.lr_decay, decayEpoch=args.lr_decay_epoch)
    
    if test_loss < best_test:
        best_test = test_loss
#         saving_name = '/features_'+args.name[1]+'_layer_'+args.name[2]+'_batchsize_'+args.name[0]
