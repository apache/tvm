...
start_time = time.time()
lib_fp32.export_library("./model/Llama_fp32.so")
...
start_time = time.time()
lib_fp16.export_library("./model/Llama_fp16.so")
...
# start_time = time.time()
# lib_mixed.export_library("./model/Llama_mixed.so")
...
start_time = time.time()
lib_posit32.export_library("./model/Llama_posit32es2.so")
