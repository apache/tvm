...
base_path = "/home/wang/venv/HPCLab/MS_LLM/models/Qwen2.5-0.5B/onnx"
...
# start_time = time.time()
# lib_fp32.export_library("./model/Qwen_fp32.so")
...
# start_time = time.time()
# lib_fp16.export_library("./model/Qwen_fp16.so")
...
start_time = time.time()
lib_mixed.export_library("./model/Qwen_mixed.so")
...
# start_time = time.time()
# lib_posit32.export_library("./model/Qwen_posit32es2.so")
...
# start_time = time.time()
# lib_posit16.export_library("./model/Qwen_posit16es2.so")
