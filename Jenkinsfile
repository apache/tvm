...
// Generated at 2022-08-11T15:35:47.984924
...
def shard_run_unittest_GPU_1_of_2() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('GPU') {
...
def shard_run_unittest_GPU_2_of_2() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('GPU') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/ut-python-gpu") {
        try {
...
def shard_run_integration_CPU_1_of_5() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
    ...
    Utils.markStageSkippedForConditional('integration: CPU 1 of 5')
  }
}

def shard_run_integration_CPU_2_of_5() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/integration-python-cpu") {
        try {
    ...
    Utils.markStageSkippedForConditional('integration: CPU 2 of 5')
  }
}

def shard_run_integration_CPU_3_of_5() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/integration-python-cpu") {
        try {
    ...
    Utils.markStageSkippedForConditional('integration: CPU 3 of 5')
  }
}

def shard_run_integration_CPU_4_of_5() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/integration-python-cpu") {
        try {
    ...
    Utils.markStageSkippedForConditional('integration: CPU 4 of 5')
  }
}

def shard_run_integration_CPU_5_of_5() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/integration-python-cpu") {
        try {
    ...
    Utils.markStageSkippedForConditional('integration: CPU 5 of 5')
  }
}
...
def shard_run_test_Hexagon_1_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 1 of 9')
  }
}

def shard_run_test_Hexagon_2_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-hexagon") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 2 of 9')
  }
}

def shard_run_test_Hexagon_3_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-hexagon") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 3 of 9')
  }
}

def shard_run_test_Hexagon_4_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-hexagon") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 4 of 9')
  }
}

def shard_run_test_Hexagon_5_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-hexagon") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 5 of 9')
  }
}

def shard_run_test_Hexagon_6_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-hexagon") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 6 of 9')
  }
}

def shard_run_test_Hexagon_7_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-hexagon") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 7 of 9')
  }
}

def shard_run_test_Hexagon_8_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-hexagon") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 8 of 9')
  }
}

def shard_run_test_Hexagon_9_of_9() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-hexagon") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Hexagon 9 of 9')
  }
}


def shard_run_integration_aarch64_1_of_3() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('ARM-SMALL') {
    ...
    Utils.markStageSkippedForConditional('integration: aarch64 1 of 3')
  }
}

def shard_run_integration_aarch64_2_of_3() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('ARM-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/ut-python-arm") {
        try {
    ...
    Utils.markStageSkippedForConditional('integration: aarch64 2 of 3')
  }
}

def shard_run_integration_aarch64_3_of_3() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('ARM-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/ut-python-arm") {
        try {
    ...
    Utils.markStageSkippedForConditional('integration: aarch64 3 of 3')
  }
}


def shard_run_topi_GPU_1_of_2() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('GPU') {
...
def shard_run_frontend_aarch64_1_of_1() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('ARM-SMALL') {
    ...
    Utils.markStageSkippedForConditional('frontend: aarch64 1 of 1')
  }
}


def shard_run_test_Cortex_M_1_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 1 of 14')
  }
}

def shard_run_test_Cortex_M_2_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 2 of 14')
  }
}

def shard_run_test_Cortex_M_3_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 3 of 14')
  }
}

def shard_run_test_Cortex_M_4_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 4 of 14')
  }
}

def shard_run_test_Cortex_M_5_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 5 of 14')
  }
}

def shard_run_test_Cortex_M_6_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 6 of 14')
  }
}

def shard_run_test_Cortex_M_7_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 7 of 14')
  }
}

def shard_run_test_Cortex_M_8_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 8 of 14')
  }
}

def shard_run_test_Cortex_M_9_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 9 of 14')
  }
}

def shard_run_test_Cortex_M_10_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 10 of 14')
  }
}

def shard_run_test_Cortex_M_11_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 11 of 14')
  }
}

def shard_run_test_Cortex_M_12_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 12 of 14')
  }
}

def shard_run_test_Cortex_M_13_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 13 of 14')
  }
}

def shard_run_test_Cortex_M_14_of_14() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('CPU-SMALL') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/test-cortexm") {
        try {
    ...
    Utils.markStageSkippedForConditional('test: Cortex-M 14 of 14')
  }
}
...
stage('Test') {
  ...
  parallel(
  'unittest: GPU 1 of 2': {
    shard_run_unittest_GPU_1_of_2()
  },
  'unittest: GPU 2 of 2': {
    shard_run_unittest_GPU_2_of_2()
  },
  'integration: CPU 1 of 5': {
    shard_run_integration_CPU_1_of_5()
  },
  'integration: CPU 2 of 5': {
    shard_run_integration_CPU_2_of_5()
  },
  'integration: CPU 3 of 5': {
    shard_run_integration_CPU_3_of_5()
  },
  'integration: CPU 4 of 5': {
    shard_run_integration_CPU_4_of_5()
  },
  'integration: CPU 5 of 5': {
    shard_run_integration_CPU_5_of_5()
  },
  'python: i386 1 of 3': {
  ...
  'test: Hexagon 1 of 9': {
    shard_run_test_Hexagon_1_of_9()
  },
  'test: Hexagon 2 of 9': {
    shard_run_test_Hexagon_2_of_9()
  },
  'test: Hexagon 3 of 9': {
    shard_run_test_Hexagon_3_of_9()
  },
  'test: Hexagon 4 of 9': {
    shard_run_test_Hexagon_4_of_9()
  },
  'test: Hexagon 5 of 9': {
    shard_run_test_Hexagon_5_of_9()
  },
  'test: Hexagon 6 of 9': {
    shard_run_test_Hexagon_6_of_9()
  },
  'test: Hexagon 7 of 9': {
    shard_run_test_Hexagon_7_of_9()
  },
  'test: Hexagon 8 of 9': {
    shard_run_test_Hexagon_8_of_9()
  },
  'test: Hexagon 9 of 9': {
    shard_run_test_Hexagon_9_of_9()
  },
  'integration: aarch64 1 of 3': {
    shard_run_integration_aarch64_1_of_3()
  },
  'integration: aarch64 2 of 3': {
    shard_run_integration_aarch64_2_of_3()
  },
  'integration: aarch64 3 of 3': {
    shard_run_integration_aarch64_3_of_3()
  },
  'topi: GPU 1 of 2': {
    shard_run_topi_GPU_1_of_2()
  },
  'topi: GPU 2 of 2': {
    shard_run_topi_GPU_2_of_2()
  },
  'frontend: GPU 1 of 6': {
  ...
  'frontend: aarch64 1 of 1': {
    shard_run_frontend_aarch64_1_of_1()
  },
  'test: Cortex-M 1 of 14': {
    shard_run_test_Cortex_M_1_of_14()
  },
  'test: Cortex-M 2 of 14': {
    shard_run_test_Cortex_M_2_of_14()
  },
  'test: Cortex-M 3 of 14': {
    shard_run_test_Cortex_M_3_of_14()
  },
  'test: Cortex-M 4 of 14': {
    shard_run_test_Cortex_M_4_of_14()
  },
  'test: Cortex-M 5 of 14': {
    shard_run_test_Cortex_M_5_of_14()
  },
  'test: Cortex-M 6 of 14': {
    shard_run_test_Cortex_M_6_of_14()
  },
  'test: Cortex-M 7 of 14': {
    shard_run_test_Cortex_M_7_of_14()
  },
  'test: Cortex-M 8 of 14': {
    shard_run_test_Cortex_M_8_of_14()
  },
  'test: Cortex-M 9 of 14': {
    shard_run_test_Cortex_M_9_of_14()
  },
  'test: Cortex-M 10 of 14': {
    shard_run_test_Cortex_M_10_of_14()
  },
  'test: Cortex-M 11 of 14': {
    shard_run_test_Cortex_M_11_of_14()
  },
  'test: Cortex-M 12 of 14': {
    shard_run_test_Cortex_M_12_of_14()
  },
  'test: Cortex-M 13 of 14': {
    shard_run_test_Cortex_M_13_of_14()
  },
  'test: Cortex-M 14 of 14': {
    shard_run_test_Cortex_M_14_of_14()
  },
