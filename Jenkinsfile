...
// Generated at 2022-05-25T14:37:10.011118
...
def shard_run_frontend_GPU_1_of_3() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('GPU') {
...
def shard_run_frontend_GPU_2_of_3() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('GPU') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/frontend-python-gpu") {
        try {
...
def shard_run_frontend_GPU_3_of_3() {
  if (!skip_ci && is_docs_only_build != 1) {
    node('GPU') {
      ws("workspace/exec_${env.EXECUTOR_NUMBER}/tvm/frontend-python-gpu") {
        try {
...
stage('Test') {
  ...
  'frontend: GPU 1 of 3': {
    shard_run_frontend_GPU_1_of_3()
  },
  'frontend: GPU 2 of 3': {
    shard_run_frontend_GPU_2_of_3()
  },
  'frontend: GPU 3 of 3': {
    shard_run_frontend_GPU_3_of_3()
  },
  'topi: aarch64 1 of 2': {
