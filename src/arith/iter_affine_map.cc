...
class IterMapRewriter : public ExprMutator {
 ...
 private:
  ...
  std::unordered_map<IterMark, IterPaddingInfo, ffi::StructuralHash, ffi::StructuralEqual> padded_iter_map_;

  // Map from padded iter mark to it's origin mark
  std::unordered_map<IterMark, IterMark, ffi::StructuralHash, ffi::StructuralEqual> padded_origin_map_;
