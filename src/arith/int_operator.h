...
template <>
inline bool WillOverflow<tirx::AddNode>(int64_t x, int64_t y, int64_t min_value, int64_t max_value) {
...
template <>
inline bool WillOverflow<tirx::SubNode>(int64_t x, int64_t y, int64_t min_value, int64_t max_value) {
  if ((y > 0) && (x < min_value + y)) return true;
  if ((y < 0) && (x > max_value + y)) return true;
  return false;
}
...
template <>
inline bool WillOverflow<tirx::MulNode>(int64_t x, int64_t y, int64_t min_value, int64_t max_value) {
  if (y == 0) return false;
  if (y > 0) {
...
template <>
inline bool WillOverflow<tirx::ModNode>(int64_t x, int64_t y, int64_t min_value, int64_t max_value) {
  return y == 0;
}
