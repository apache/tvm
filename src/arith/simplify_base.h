 ...
 * \brief Expression mutator base class for arith simplifiers.
 */
#ifndef TVM_ARITH_SIMPLIFY_BASE_H_
#define TVM_ARITH_SIMPLIFY_BASE_H_
...
#endif  // TVM_ARITH_SIMPLIFY_BASE_H_
