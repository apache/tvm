...
class RewriteSimplifier::Impl : public SimplifierBase {
 public:
  ...
  UnchangedOr<ffi::Any> Mutate_(const prim::AddNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::SubNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::MulNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::DivNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::ModNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::FloorDivNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::FloorModNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::MinNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::MaxNode* op, InplaceMode inplace_mode) override;
  ...
  UnchangedOr<ffi::Any> Mutate_(const prim::AndNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::OrNode* op, InplaceMode inplace_mode) override;
  UnchangedOr<ffi::Any> Mutate_(const prim::NotNode* op, InplaceMode inplace_mode) override;
  ...
  UnchangedOr<ffi::Any> Mutate_(const prim::CastNode* op, InplaceMode inplace_mode) override;
