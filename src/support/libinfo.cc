...
#ifndef TVM_INFO_USE_GNA_CODEGEN
#define TVM_INFO_USE_GNA_CODEGEN "NOT-FOUND"
#endif

#ifndef TVM_INFO_USE_GNA_RUNTIME
#define TVM_INFO_USE_GNA_RUNTIME "NOT-FOUND"
#endif
...
TVM_DLL ffi::Map<ffi::String, ffi::String> GetLibInfo() {
  ffi::Map<ffi::String, ffi::String> result = {
      ...
      {"USE_GNA_CODEGEN", TVM_INFO_USE_GNA_CODEGEN},
      {"USE_GNA_RUNTIME", TVM_INFO_USE_GNA_RUNTIME},
