...
class VulkanFallbackModuleNode : public ffi::ModuleObj {
 public:
  ...
  ffi::Bytes SaveToBytes() const final {
    ...
    // VulkanModuleNode::SaveToBytes in src/backend/vulkan/runtime/vulkan_module.cc
    ...
    // vector); see src/backend/vulkan/runtime/spirv_shader.h.
    std::string buffer;
 ...
 private:
  ...
  // src/backend/vulkan/runtime/vulkan_module.cc.  Multi-shader uniform
