 ...
 * under the License.
 */
#ifndef TVM_S_TIR_SCRIPT_BUILDER_UTILS_H_
#define TVM_S_TIR_SCRIPT_BUILDER_UTILS_H_

#include <tvm/s_tir/script/builder/frame.h>

#include "../../../tirx/script/builder/utils.h"
...
#endif  // TVM_S_TIR_SCRIPT_BUILDER_UTILS_H_
