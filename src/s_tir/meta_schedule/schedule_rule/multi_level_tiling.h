 ...
 * under the License.
 */
#ifndef TVM_S_TIR_META_SCHEDULE_SCHEDULE_RULE_MULTI_LEVEL_TILING_H_
...
class MultiLevelTilingNode : public ScheduleRuleNode {
 ...
 public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO("s_tir.meta_schedule.MultiLevelTiling", MultiLevelTilingNode,
                              ScheduleRuleNode);
};
...
#endif  // TVM_S_TIR_META_SCHEDULE_SCHEDULE_RULE_MULTI_LEVEL_TILING_H_
