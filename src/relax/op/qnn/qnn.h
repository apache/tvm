...
/*!
 * \file src/relax/op/qnn/qnn.h
 * \brief The functions to make Relax QNN operator calls.
 */
#ifndef TVM_RELAX_OP_QNN_QNN_H_
#define TVM_RELAX_OP_QNN_QNN_H_
