...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      .def("tvm.relax.backend.RegisterPatterns", RegisterPatterns)
      .def("tvm.relax.backend.RemovePatterns", RemovePatterns)
      .def("tvm.relax.backend.GetPatternsWithPrefix", GetPatternsWithPrefix)
      .def("tvm.relax.backend.GetPattern", GetPattern);
}
