 ...
 private:
  ...
  void EmitCallPacked(ffi::String name, const ffi::Array<PrimExpr>& args,
    ...
    if (dst_anylist_slot >= 0) {
      ...
      this->EmitStmt(
          tirx::Evaluate(tirx::Call(DataType::Int(32), tirx::builtin::tvm_call_packed(), all_args)));
    }
  }
  ...
  void EmitCallCPacked(const tirx::PrimFunc& prim_func, const ffi::Array<PrimExpr>& args,
    ...
    if (dst_anylist_slot >= 0) {
      ...
      this->EmitStmt(
          tirx::Evaluate(tirx::Call(DataType::Int(32), tirx::builtin::tvm_call_cpacked(), all_args)));
    }
  }
