...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      .def("relax._shape_args", [](ffi::AnyView /*ctx*/, ShapeExpr node) -> ffi::Array<ffi::ObjectRef> {
        ffi::Array<ffi::ObjectRef> wrapper;
        wrapper.push_back(node->values);
        return wrapper;
      })
      .def("relax._dtype_str", [](ffi::AnyView /*ctx*/, DataTypeImm node) -> ffi::String {
      ...
      .def("relax._dataflow_outputs",
          [](ffi::AnyView /*ctx*/, DataflowBlock block) -> ::tvm::ffi::Function {
