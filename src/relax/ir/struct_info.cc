...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      .def("relax._func_si_args", [](ffi::AnyView /*ctx*/, FuncStructInfo node) -> ffi::List<ffi::Any> {
      ...
      .def("relax._func_si_kwargs", [](ffi::AnyView /*ctx*/, FuncStructInfo node) -> ffi::Dict<ffi::String, ffi::Any> {
      ...
      .def("relax._empty_array",
          [](ffi::AnyView /*ctx*/, ObjectStructInfo) -> ffi::Array<ffi::ObjectRef> {
            return ffi::Array<ffi::ObjectRef>();
          })
      .def("relax._prim_si_args", [](ffi::AnyView /*ctx*/, PrimStructInfo node) -> ffi::List<ffi::Any> {
        ffi::List<ffi::Any> args;
      ...
      .def("relax._prim_si_kwargs", [](ffi::AnyView /*ctx*/, PrimStructInfo node) -> ffi::Dict<ffi::String, ffi::Any> {
        ffi::Dict<ffi::String, ffi::Any> kwargs;
        if (node->value.defined()) {
      ...
      .def("relax._shape_si_args", [](ffi::AnyView /*ctx*/, ShapeStructInfo node) -> ffi::List<ffi::Any> {
        ffi::List<ffi::Any> args;
      ...
      .def("relax._shape_si_kwargs", [](ffi::AnyView /*ctx*/, ShapeStructInfo node) -> ffi::Dict<ffi::String, ffi::Any> {
        ffi::Dict<ffi::String, ffi::Any> kwargs;
        if (!node->values.defined()) {
