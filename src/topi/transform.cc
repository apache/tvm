...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      ...
      .def_packed("tvm.topi.layout_transform",
                  [](ffi::PackedArgs args, ffi::Any* rv) {
                    *rv =
      ...
      .def("tvm.topi.relax_dynamic_strided_slice",
      ...
      .def_packed("tvm.topi.matrix_set_diag",
                  [](ffi::PackedArgs args, ffi::Any* rv) {
