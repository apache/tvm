...
void BinaryOpMatchTypes(PrimExpr& lhs, PrimExpr& rhs, Span span) {  // NOLINT(*)
  ...
  // We keep dtypes conversion to be relatively consistent to reduce the amount code generated by operators.
  // This can be helpful for users to find potential type conversion problems. The following are exceptions:
