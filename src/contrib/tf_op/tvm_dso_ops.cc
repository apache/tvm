...
REGISTER_OP("TvmDsoOp")
    ...
    .Attr("ListT: list({float16, float32, float64, int8, int16, int32, int64, uint8, uint16,"\
                       "uint32, uint64})")
    .Input("dynamic_output_shape: int64")
    .Output("output: output_dtype")
    .Attr("lib_path: string")
    .Attr("func_name: string")
    .Attr("output_dtype: {float16, float32, float64, int8, int16, int32, int64, uint8, uint16," \
