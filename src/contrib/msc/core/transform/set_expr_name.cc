...
class FuncNameGetter : public ExprVisitor {
 public:
  explicit FuncNameGetter(const ffi::Array<ffi::String>& arg_names) : arg_names_(arg_names) {}
 ...
 private:
  ffi::String name_;
  ffi::Array<ffi::String> arg_names_;
};
...
class RelaxExprNameSetter : public ExprVisitor {
 public:
  explicit RelaxExprNameSetter(const IRModule& ref_module, const ffi::String& target,
                               const ffi::Map<ffi::String, ffi::String>& var_names)
  ...
  void VisitBinding_(const VarBindingNode* binding, const CallNode* val) {
    ...
    if (name_hint.size() > 0) {
      ...
      try {
        ...
        LOG(WARNING) << "Failed to GetInputTypes for " << ffi::GetRef<Call>(val) << " : "
                     << err.what();
        throw err;
      }
 ...
 private:
  ...
  ffi::Map<ffi::String, Expr> setted_names_;
  ffi::Map<ffi::String, ffi::String> constant_consumers_;
  std::set<ffi::String> setted_blocks_;
  ffi::Array<ffi::String> block_stack_;
  ffi::Map<Expr, ffi::String> expr_names_;
  ffi::Map<Expr, Function> local_funcs_;
  IRModule ref_module_;
  ffi::String target_;
  ffi::Map<ffi::String, ffi::String> var_names_;
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef().def("tvm.relax.transform.SetRelaxExprName", SetRelaxExprName);
}
