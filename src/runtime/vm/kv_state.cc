...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      .def_method("tvm.vm.builtin.kv_state_clear", &KVStateObj::Clear)
      .def_method("tvm.vm.builtin.kv_state_add_sequence", &KVStateObj::AddSequence)
      .def_method("tvm.vm.builtin.kv_state_remove_sequence", &KVStateObj::RemoveSequence)
      .def_method("tvm.vm.builtin.kv_state_fork_sequence", &KVStateObj::ForkSequence)
      .def_method("tvm.vm.builtin.kv_state_popn", &KVStateObj::PopN)
      .def_packed("tvm.vm.builtin.kv_state_begin_forward",
      ...
      .def_method("tvm.vm.builtin.kv_state_end_forward", &KVStateObj::EndForward);
}
...
TVM_FFI_STATIC_INIT_BLOCK() {
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
      .def_method("tvm.vm.builtin.kv_cache_disagg_prepare_recv",
                  &AttentionKVCacheObj::DisaggPrepareRecv)
      .def_method("tvm.vm.builtin.kv_cache_disagg_mark_send", &AttentionKVCacheObj::DisaggMarkSend)
      .def_method("tvm.vm.builtin.attention_kv_cache_enable_sliding_window_for_seq",
                  &AttentionKVCacheObj::EnableSlidingWindowForSeq)
      .def_method("tvm.vm.builtin.attention_kv_cache_commit_accepted_token_tree_nodes",
                  &AttentionKVCacheObj::CommitAcceptedTokenTreeNodes)
      .def_method("tvm.vm.builtin.attention_kv_cache_empty", &AttentionKVCacheObj::Empty)
      .def_method("tvm.vm.builtin.attention_kv_cache_get_num_available_pages",
                  &AttentionKVCacheObj::GetNumAvailablePages)
      .def_method("tvm.vm.builtin.attention_kv_cache_get_total_sequence_length",
                  &AttentionKVCacheObj::GetTotalSequenceLength)
      .def_method("tvm.vm.builtin.attention_kv_cache_get_query_positions",
                  &AttentionKVCacheObj::GetQueryPositions)
      .def_method("tvm.vm.builtin.attention_kv_cache_debug_get_kv",
                  &AttentionKVCacheObj::DebugGetKV)
      .def_method("tvm.vm.builtin.attention_kv_cache_debug_get_kv_mla",
                  &AttentionKVCacheObj::DebugGetKVMLA)
      .def("tvm.vm.builtin.attention_kv_cache_attention_with_fused_qkv",
      ...
      .def("tvm.vm.builtin.attention_kv_cache_self_attention",
...
TVM_FFI_STATIC_INIT_BLOCK() {
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
      .def_method("tvm.vm.builtin.rnn_state_get", &RNNStateObj::Get)
      .def("tvm.vm.builtin.rnn_state_set",
           [](RNNState state, int64_t layer_id, int64_t state_id, Tensor data) {
             state->Set(layer_id, state_id, data);
             return state;
           })
      .def_method("tvm.vm.builtin.rnn_state_debug_get", &RNNStateObj::DebugGet);
}
