...
/*!
 * \file tvm/runtime/crt/common/ndarray.h
 * \brief Abstract device memory management API
 */
#ifndef TVM_RUNTIME_CRT_COMMON_NDARRAY_H_
#define TVM_RUNTIME_CRT_COMMON_NDARRAY_H_
...
#endif  // TVM_RUNTIME_CRT_COMMON_NDARRAY_H_
