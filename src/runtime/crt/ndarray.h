...
TVMNDArray TVMNDArray_Create(uint32_t ndim, int64_t * shape, DLDataType dtype, DLContext ctx);

TVMNDArray TVMNDArray_Empty(uint32_t ndim, int64_t * shape, DLDataType dtype, DLContext ctx);
