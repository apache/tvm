 ...
 * \brief Deprecated include — SPIRVShader has moved to src/runtime/vulkan/spirv_shader.h.
 *        This header is kept for backward compatibility; include the new path directly.
 */
