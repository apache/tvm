 ...
 */
#ifndef TVM_RUNTIME_HEXAGON_DEVICE_HEXAGON_STUBAPI_H_
#define TVM_RUNTIME_HEXAGON_DEVICE_HEXAGON_STUBAPI_H_
...
#endif  // __ANDROID__
#endif  // TVM_RUNTIME_HEXAGON_DEVICE_HEXAGON_STUBAPI_H_
