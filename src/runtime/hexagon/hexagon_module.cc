...
static ffi::Module HexagonModuleCreateInternal(std::string data, std::string fmt,
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef().def(
      ...
      [](ffi::String data, ffi::String fmt, ffi::Map<ffi::String, FunctionInfo> fmap,
         ffi::String asm_str, ffi::String obj_str, ffi::String ir_str, ffi::String bc_str) {
        return HexagonModuleCreateInternal(std::string(data), std::string(fmt), fmap,
                                           std::string(asm_str), std::string(obj_str),
                                           std::string(ir_str), std::string(bc_str));
      });
}
