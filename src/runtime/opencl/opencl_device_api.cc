...
TVM_REGISTER_GLOBAL("device_api.opencl.AllocNdWithScope").set_body([](TVMArgs args, TVMRetValue* rv) {
...
TVM_REGISTER_GLOBAL("device_api.opencl.FreeNdWithScope").set_body([](TVMArgs args, TVMRetValue* rv) {
