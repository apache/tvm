...
TVM_REGISTER_OP("tir.pow").set_attr<FLowerIntrinsic>("hip.FLowerIntrinsic",
                                                     DispatchPureExtern<HIPMath>);

TVM_REGISTER_OP("tir.popcount")
    .set_attr<FLowerIntrinsic>("hip.FLowerIntrinsic", DispatchPureExtern<HIPPopcount>);

TVM_REGISTER_OP("tir.tvm_warp_shuffle")
    .set_attr<FLowerIntrinsic>("hip.FLowerIntrinsic", DispatchHIPShuffle<HIPWarpIntrinsic>);
...
TVM_REGISTER_OP("tir.tvm_warp_activemask")
    .set_attr<FLowerIntrinsic>("hip.FLowerIntrinsic", DispatchHIPWarpActiveMask);

TVM_REGISTER_OP("tir.fmod")
    .set_attr<FLowerIntrinsic>("hip.FLowerIntrinsic", DispatchPureExtern<HIPMath>);

// Register low-level builtin ops.
// TODO(tvm-team): consider make HIP its own subfolder and create a file for low-level builtins.
