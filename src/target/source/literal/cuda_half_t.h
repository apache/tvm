...
CUDA_UNSUPPORTED_HALF2_MATH_UNARY(htanh2, htanh)
CUDA_UNSUPPORTED_HALF2_MATH_UNARY(htan2, htan)
CUDA_UNSUPPORTED_HALF2_MATH_UNARY(hatan2, hatan)
CUDA_UNSUPPORTED_HALF2_MATH_UNARY(herf2, herf)
...
CUDA_UNSUPPORTED_BFLOAT2_MATH_UNARY(htanh2, htanh)
CUDA_UNSUPPORTED_BFLOAT2_MATH_UNARY(htan2, htan)
CUDA_UNSUPPORTED_BFLOAT2_MATH_UNARY(hatan2, hatan)
CUDA_UNSUPPORTED_BFLOAT2_MATH_UNARY(herf2, herf)
