...
struct BufferTouch {
  enum class AccessType {
    ...
    /*! \brief Buffer access occurs in tirx::builtin::assume() */
    Assume,
  };
...
/*!
 * \brief Represents the flow of control through a `tirx::Stmt`
 *
 * This class contains an internal representation of the possible
 * control flow that may occur during execution of a `tirx::Stmt`.  It
...
class ControlFlowGraph {
 public:
   ...
   */
  void RemoveStore(const tirx::BufferStore& store);
