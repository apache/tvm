...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      ...
      .def("tirx.AxisIsMemoryAxis", [](Axis axis) { return axis->IsMemoryAxis(); })
      .def("tirx.AxisGetScope", [](Axis axis) { return axis->GetScope(); })
      .def("tirx.AxisGetSubscope", [](Axis axis) { return axis->GetSubscope(); })
      .def("tirx.AxisGet", [](ffi::String name) -> Axis { return Axis::Get(name); });
}
...
TVM_FFI_STATIC_INIT_BLOCK() {
  // Register thread axes in declaration order.
  refl::EnumDef<AxisNode>("bx")
      .set_attr("thread", true)
      .set_attr("scope", ExecScope("thread"))
      .set_attr("subscope", ExecScope("cta"));

  refl::EnumDef<AxisNode>("by")
      .set_attr("thread", true)
      .set_attr("scope", ExecScope("thread"))
      .set_attr("subscope", ExecScope("cta"));

  refl::EnumDef<AxisNode>("bz")
      .set_attr("thread", true)
      .set_attr("scope", ExecScope("thread"))
      .set_attr("subscope", ExecScope("cta"));

  refl::EnumDef<AxisNode>("cbx")
      .set_attr("thread", true)
      .set_attr("scope", ExecScope("cluster"))
      .set_attr("subscope", ExecScope("cta"));

  refl::EnumDef<AxisNode>("cby")
      .set_attr("thread", true)
      .set_attr("scope", ExecScope("cluster"))
      .set_attr("subscope", ExecScope("cta"));

  refl::EnumDef<AxisNode>("cbz")
      .set_attr("thread", true)
      .set_attr("scope", ExecScope("cluster"))
      .set_attr("subscope", ExecScope("cta"));
  ...
  // Register memory axes.
  // clang-format off
  refl::EnumDef<AxisNode>("m")
      .set_attr("thread", false);

  refl::EnumDef<AxisNode>("P")
      .set_attr("thread", false);

  refl::EnumDef<AxisNode>("F")
      .set_attr("thread", false);

  refl::EnumDef<AxisNode>("Bank")
      .set_attr("thread", false);

  refl::EnumDef<AxisNode>("TCol")
      .set_attr("thread", false);

  refl::EnumDef<AxisNode>("TLane")
      .set_attr("thread", false);
  // clang-format on
}
