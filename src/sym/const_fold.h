 ...
 */
#ifndef TVM_SYM_CONST_FOLD_H_
#define TVM_SYM_CONST_FOLD_H_

#include "../ir/prim/const_fold.h"
#include "int_operator.h"

#define TVM_SYM_CONST_PROPAGATION(BODY) TVM_PRIM_CONST_PROPAGATION(BODY)
