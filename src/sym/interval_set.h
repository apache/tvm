 ...
 */
#ifndef TVM_SYM_INTERVAL_SET_H_
#define TVM_SYM_INTERVAL_SET_H_
...
class IntervalSetNode : public IntSetNode {
 public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("sym.IntervalSet", IntervalSetNode, IntSetNode);
};
