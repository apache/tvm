...
PrimExpr::PrimExpr(int32_t value) : PrimExpr(prim::IntImm::Int32(value)) {}

PrimExpr::PrimExpr(float value) : PrimExpr(prim::FloatImm(PrimType::Float(32), value)) {}
...
PrimExpr TypeTraits<PrimExpr>::ConvertFallbackValue(StrictBool value) {
  return prim::IntImm::Bool(value);
}

PrimExpr TypeTraits<PrimExpr>::ConvertFallbackValue(int64_t value) {
  return TypeTraits<prim::IntImm>::ConvertFallbackValue(value);
}

PrimExpr TypeTraits<PrimExpr>::ConvertFallbackValue(double value) {
  return TypeTraits<prim::FloatImm>::ConvertFallbackValue(value);
}
  ...
  refl::GlobalDef().def("ir.Range",
                        [](PrimExpr begin, ffi::Optional<PrimExpr> end, Span span) -> Range {
                          if (end.has_value()) {
                            ...
                            return Range(prim::IntImm(begin.ty(), 0), begin, span);
                          }
                        });
}
