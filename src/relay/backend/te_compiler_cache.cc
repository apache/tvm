...
class QnnPatternMatcher {
 public:
  QnnPatternMatcher()
      : qnn_conv2d_op_(Op::Get("qnn.conv2d")),
        ...
        qnn_dense_pack_op_(Op::Get("qnn.dense_pack")),
 ...
 private:
  ...
  const std::vector<std::deque<POper>> supported_patterns_ = {
      ...
      {P_QDensePack, P_BiasAdd, P_QRequantize},  // qnn.dense_pack -> bias_add -> qnn.requantize
      {P_QDensePack, P_QRequantize},             // qnn.dense_pack -> qnn.requantize
