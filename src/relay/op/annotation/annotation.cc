...
Expr CheckPointconvpsum(Expr data) {
  static const Op& op = Op::Get("annotation.checkpointconvpsum");
  return Call(op, {data}, Attrs{}, {});
}

TVM_REGISTER_GLOBAL("relay.op.annotation._make.checkpointconvpsum").set_body_typed([](Expr data) {
  static const Op& op = Op::Get("annotation.checkpointconvpsum");
  return Call(op, {data}, Attrs{}, {});
});

RELAY_REGISTER_OP("annotation.checkpointconvpsum")
    .describe(R"code(
Mark a checkpointconvpsum for checkpointing memory optimization.
)code" TVM_ADD_FILELINE)
    .set_num_inputs(1)
    .set_support_level(10)
    .add_argument("data", "Tensor", "The input data.")
...
Expr CheckPointconvadd(Expr data) {
  static const Op& op = Op::Get("annotation.checkpointconvadd");
  return Call(op, {data}, Attrs{}, {});
}

TVM_REGISTER_GLOBAL("relay.op.annotation._make.checkpointconvadd").set_body_typed([](Expr data) {
  static const Op& op = Op::Get("annotation.checkpointconvadd");
  return Call(op, {data}, Attrs{}, {});
});

RELAY_REGISTER_OP("annotation.checkpointconvadd")
    .describe(R"code(
Mark a checkpointconvadd for checkpointing memory optimization.
)code" TVM_ADD_FILELINE)
    .set_num_inputs(1)
    .set_support_level(10)
    .add_argument("data", "Tensor", "The input data.")
...
Expr CheckPointaddpsumm(Expr data) {
  static const Op& op = Op::Get("annotation.checkpointaddpsumm");
  return Call(op, {data}, Attrs{}, {});
}

TVM_REGISTER_GLOBAL("relay.op.annotation._make.checkpointaddpsumm").set_body_typed([](Expr data) {
  static const Op& op = Op::Get("annotation.checkpointaddpsumm");
  return Call(op, {data}, Attrs{}, {});
});

RELAY_REGISTER_OP("annotation.checkpointaddpsumm")
    .describe(R"code(
Mark a checkpointaddpsumm for checkpointing memory optimization.
)code" TVM_ADD_FILELINE)
    .set_num_inputs(1)
    .set_support_level(10)
    .add_argument("data", "Tensor", "The input data.")
...
TVM_REGISTER_GLOBAL("relay.op.annotation._make.checkpointbiass").set_body_typed([](Expr data) {
  static const Op& op = Op::Get("annotation.checkpointbiass");
  return Call(op, {data}, Attrs{}, {});
});

RELAY_REGISTER_OP("annotation.checkpointbiass")
    .describe(R"code(
Mark a checkpointbiass for checkpointing memory optimization.
)code" TVM_ADD_FILELINE)
    .set_num_inputs(1)
    .set_support_level(10)
    .add_argument("data", "Tensor", "The input data.")
...
Expr CheckPointSiso(Expr data) {
  static const Op& op = Op::Get("annotation.checkpointsiso");
  return Call(op, {data}, Attrs{}, {});
}

TVM_REGISTER_GLOBAL("relay.op.annotation._make.checkpointsiso").set_body_typed([](Expr data) {
  static const Op& op = Op::Get("annotation.checkpointsiso");
  return Call(op, {data}, Attrs{}, {});
});

RELAY_REGISTER_OP("annotation.checkpointsiso")
    .describe(R"code(
Mark a checkpointsiso for checkpointing memory optimization.
)code" TVM_ADD_FILELINE)
    .set_num_inputs(1)
    .set_support_level(10)
    .add_argument("data", "Tensor", "The input data.")
...
Expr CheckPointAddPsum(Expr data) {
  static const Op& op = Op::Get("annotation.checkpointaddpsum");
  return Call(op, {data}, Attrs{}, {});
}

TVM_REGISTER_GLOBAL("relay.op.annotation._make.checkpointaddpsum").set_body_typed([](Expr data) {
  static const Op& op = Op::Get("annotation.checkpointaddpsum");
  return Call(op, {data}, Attrs{}, {});
});

RELAY_REGISTER_OP("annotation.checkpointaddpsum")
    .describe(R"code(
