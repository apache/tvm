...
Array<Array<Layout> > ROIAlignInferCorrectLayout(const Attrs& attrs,
  ...
  // We always make other operators to fit the layouts of roi_align layers and the roi_align
  // transpose followed by layout_transpose, So this inference ignores all inputs.
  ...
  return Array<Array<Layout> >{{params->layout, Layout("N5")}, {params->layout}};
}
