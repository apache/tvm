...
template <int N>
__forceinline__ __device__ void cp_async_gs(void const* const smem_addr, void* global_ptr) {
...
template <int N>
__forceinline__ __device__ void cp_async_gs_conditional(void const* const smem_addr,
