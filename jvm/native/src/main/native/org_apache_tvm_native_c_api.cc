...
// Function
JNIEXPORT void JNICALL Java_org_apache_tvm_LibInfo_tvmFFIFunctionPushArgLong(JNIEnv* env, jobject obj,
                                                                      jlong arg) {
  TVMFFIJVMStack::ThreadLocal()->packed_args.emplace_back(static_cast<int64_t>(arg));
}

JNIEXPORT void JNICALL Java_org_apache_tvm_LibInfo_tvmFFIFunctionPushArgDouble(JNIEnv* env, jobject obj,
                                                                        jdouble arg) {
  TVMFFIJVMStack::ThreadLocal()->packed_args.emplace_back(static_cast<double>(arg));
}

JNIEXPORT void JNICALL Java_org_apache_tvm_LibInfo_tvmFFIFunctionPushArgString(JNIEnv* env, jobject obj,
                                                                        jstring arg) {
...
JNIEXPORT void JNICALL Java_org_apache_tvm_LibInfo_tvmFFIFunctionPushArgHandle(JNIEnv* env, jobject obj,
                                                                               jlong arg, jint argTypeIndex) {
  TVMFFIJVMStack* stack = TVMFFIJVMStack::ThreadLocal();
  TVMFFIAny temp;
...
JNIEXPORT void JNICALL Java_org_apache_tvm_LibInfo_tvmFFIFunctionPushArgDevice(JNIEnv* env, jobject obj,
                                                                               jobject arg) {
...
JNIEXPORT void JNICALL Java_org_apache_tvm_LibInfo_tvmFFIFunctionPushArgBytes(JNIEnv* env, jobject obj,
                                                                              jbyteArray arg) {
...
JNIEXPORT jint JNICALL Java_org_apache_tvm_LibInfo_tvmFFIFunctionListGlobalNames(JNIEnv* env, jobject obj,
                                                                                 jobject jfuncNames) {
...
// Callback function
extern "C" int funcInvokeCallback(void* self, const TVMFFIAny* args, int num_args,
                                  TVMFFIAny* ret) {
  JNIEnv* env;
...
JNIEXPORT jint JNICALL Java_org_apache_tvm_LibInfo_tvmFFIDLTensorCopyFromTo(
  JNIEnv* env, jobject obj,
   jlong jfrom, jlong jto) {
  TVM_FFI_SAFE_CALL_BEGIN();
  static auto fcopy_from_to = tvm::ffi::Function::GetGlobalRequired("runtime.TVMArrayCopyFromTo");
  fcopy_from_to(reinterpret_cast<DLTensor*>(jfrom),
                reinterpret_cast<DLTensor*>(jto));
  TVM_FFI_SAFE_CALL_END();
}

JNIEXPORT jint JNICALL Java_org_apache_tvm_LibInfo_tvmFFIDLTensorCopyFromJArray(
  JNIEnv* env, jobject obj,
  jbyteArray jarr,
  jlong jto) {
  TVM_FFI_SAFE_CALL_BEGIN();
  ...
  static auto fcopy_from_bytes = tvm::ffi::Function::GetGlobalRequired("runtime.TVMArrayCopyFromBytes");
  fcopy_from_bytes(to, static_cast<void*>(pdata), size);
  env->ReleaseByteArrayElements(jarr, pdata, 0);
  TVM_FFI_SAFE_CALL_END();
}

JNIEXPORT jint JNICALL Java_org_apache_tvm_LibInfo_tvmFFIDLTensorCopyToJArray(JNIEnv* env, jobject obj,
                                                                              jlong jfrom,
                                                                              jbyteArray jarr) {
  TVM_FFI_SAFE_CALL_BEGIN();
  ...
  env->ReleaseByteArrayElements(jarr, static_cast<jbyte*>(pdata), 0);  // copy back to java array automatically
  TVM_FFI_SAFE_CALL_END();
}

JNIEXPORT jint JNICALL Java_org_apache_tvm_LibInfo_tvmSynchronize
  (JNIEnv *env, jobject obj, jint jdeviceType, jint jdeviceId) {
  TVM_FFI_SAFE_CALL_BEGIN();
