...
elseif(PYTHON)
  ...
  if(USE_VTA_FSIM)
    ...
    list(APPEND FSIM_RUNTIME_SRCS ${VTA_HW_DIR}/src/vmem/virtual_memory.cc ${VTA_HW_DIR}/src/vmem/virtual_memory.h)
  ...
  if(USE_VTA_TSIM)
    ...
    list(APPEND TSIM_RUNTIME_SRCS ${VTA_HW_DIR}/src/vmem/virtual_memory.cc ${VTA_HW_DIR}/src/vmem/virtual_memory.h)
    # Target lib: vta_tsim
