...
message(STATUS "use vta path ${VTA_HW_PATH}")
...
elseif(PYTHON)
  ...
  message(STATUS "got vta defines ${VTA_DEFINITIONS}")
  ...
  if(USE_VTA_FSIM)
    ...
    foreach(__def ${VTA_DEFINITIONS})
      message(STATUS "before:${__def}")
      string(SUBSTRING ${__def} 3 -1 __strip_def)
      message(STATUS "${__strip_def}")
      if(__LoopFirst)
        message(STATUS "add -DV")
        target_compile_definitions(vta_fsim PUBLIC "-DV${__strip_def}")
      else(__LoopFirst)
        target_compile_definitions(vta_fsim PUBLIC "-D${__strip_def}")
      endif(__LoopFirst)
      set(__LoopFirst OFF)
    endforeach()
    if(APPLE)
  ...
  if(USE_VTA_TSIM)
    ...
    foreach(__def ${VTA_DEFINITIONS})
      ...
      if(__LoopFirst)
        message(STATUS "add -DV")
        target_compile_definitions(vta_tsim PUBLIC "-DV${__strip_def}")
      else(__LoopFirst)
        target_compile_definitions(vta_tsim PUBLIC "-D${__strip_def}")
      endif(__LoopFirst)
      set(__LoopFirst OFF)
    endforeach()
    if(APPLE)
