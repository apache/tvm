...
if(USE_MICRO)
  ...
  function(tvm_crt_define_targets)
    ...
    if(GTEST_FOUND)
      ...
      target_include_directories(crttest SYSTEM PUBLIC ${GTEST_INCLUDE_DIRS} ${CMAKE_CURRENT_BINARY_DIR}/standalone_crt/include ${CMAKE_SOURCE_DIR}/src/runtime/micro)
      target_link_libraries(crttest PRIVATE ${cmake_crt_libraries} ${GTEST_BOTH_LIBRARIES} pthread dl)
