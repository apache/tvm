...
@tvm_ffi.register_object("sym.IterMapExpr")
class IterMapExpr(Expr):
    """Base class of all IterMap expressions."""


@tvm_ffi.register_object("sym.IterMark")
...
@tvm_ffi.register_object("sym.IterSplitExpr")
...
@tvm_ffi.register_object("sym.IterSumExpr")
...
@tvm_ffi.register_object("sym.IterMapResult")
