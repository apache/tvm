...
@tvm_ffi.register_object("tvm.transform.PassInfo")
...
@tvm_ffi.register_object("tvm.transform.PassContext")
...
@tvm_ffi.register_object("tvm.transform.Pass")
...
@tvm_ffi.register_object("tvm.transform.ModulePass")
...
@tvm_ffi.register_object("tvm.transform.Sequential")
