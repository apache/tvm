...
@tvm_ffi.register_object("tvm.ir.Type")
...
@tvm_ffi.register_object("tvm.ir.PrimType")
class PrimType(Type):
...
@tvm_ffi.register_object("tvm.ir.PointerType")
...
@tvm_ffi.register_object("tvm.ir.TupleType")
...
@tvm_ffi.register_object("tvm.ir.FuncType")
class FuncType(Type):
    """Function type.
...
@tvm_ffi.register_object("tvm.ir.TensorMapType")
