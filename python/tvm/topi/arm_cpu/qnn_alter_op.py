...
def alter_requantize_layout(attrs, inputs, _tinfos, _out_type):
    ...
    the requantize schedule alsi "plays along" with this hack!"""
...
def alter_add_layout(_attrs, inputs, _tinfos, _out_type):
    """Fuses the zero point for a previous quantized operator with the bias add operation. Currently
    only supports qnn.conv2d, but qnn.dense support should be added. Note that this optimization
