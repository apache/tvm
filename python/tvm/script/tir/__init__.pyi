...
def cast(value: PrimExpr, dtype: str): ...
def ramp(base: PrimExpr, stride: Any, lanes: int): ...
def broadcast(value: PrimExpr, lanes: int): ...
def iter_var(var: Union[Var, str], dom: Range, iter_type: int, thread_tag: str): ...
def max(a: PrimExpr, b: PrimExpr): ...
def min(a: PrimExpr, b: PrimExpr): ...
def get_axis(begin: PrimExpr, end: PrimExpr, iter_type: int): ...
...
def evaluate(value: PrimExpr): ...
def reinterpret(value: PrimExpr, dtype: str): ...
def store(var: Var, index: PrimExpr, value: PrimExpr, predicate: PrimExpr = True): ...
