...
class float16(PrimExpr):
    def __init__(self: float16, imm: Union[PrimExpr, int, float, str]): ...

class float32(PrimExpr):
    def __init__(self: float32, imm: Union[PrimExpr, int, float, str]): ...

class float64(PrimExpr):
    def __init__(self: float64, imm: Union[PrimExpr, int, float, str]): ...
