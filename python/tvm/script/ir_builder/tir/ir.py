...
def buffer(
    ...
    if strides is not None:
        ...
        strides = []
    return _ffi_api.Buffer(  # type: ignore[attr-defined]
        shape,
        dtype,
        "",
        data,
...
def prim_func(is_private: bool = False) -> frame.PrimFuncFrame:
    ...
    res : frame.PrimFuncFrame
        The PrimFuncFrame.
    """
    return _ffi_api.PrimFunc(is_private)  # type: ignore[attr-defined]
...
def arg(name: str, obj: Var | Buffer) -> Var | Buffer:
    ...
    res : Union[Var, Buffer]
        The argument.
    """
    return _ffi_api.Arg(name, obj)  # type: ignore[attr-defined]
...
def func_name(name: str) -> None:
    ...
    """
    _ffi_api.FuncName(name)  # type: ignore[attr-defined]
...
def func_attr(attrs: dict[str, Any]) -> None:
    ...
    """
    _ffi_api.FuncAttrs(attrs)  # type: ignore[attr-defined]
...
def func_ret(ret_type: Type) -> Type:
    ...
    res : Type
        The return type.
    """
    return _ffi_api.FuncRet(ret_type)  # type: ignore[attr-defined]
...
def match_buffer(
    ...
    if strides is not None:
        ...
        strides = []
    return _ffi_api.MatchBuffer(  # type: ignore[attr-defined]
        param,
        shape,
        dtype,
        data,
...
def init() -> frame.BlockInitFrame:
    ...
    res : frame.BlockInitFrame
        The BlockInitFrame.
    """
    return _ffi_api.Init()  # type: ignore[attr-defined]
...
def where(predicate: PrimExpr | int) -> None:
    ...
    _ffi_api.Where(predicate)  # type: ignore[attr-defined]
...
def reads(*buffer_slices: list[BufferRegion | BufferLoad]) -> None:
    ...
    _ffi_api.Reads(buffer_slices)  # type: ignore[attr-defined]
...
def writes(*buffer_slices: list[BufferRegion | BufferLoad]) -> None:
    ...
    if len(buffer_slices) == 1:
        ...
        buffer_slices = list(buffer_slices)  # type: ignore[assignment]
    _ffi_api.Writes(buffer_slices)  # type: ignore[attr-defined]
...
def sblock_attr(attrs: dict[str, Any]) -> None:
    ...
    """
    return _ffi_api.BlockAttrs(attrs)  # type: ignore[attr-defined]
...
def alloc_buffer(
    ...
    if strides is not None:
        ...
        strides = []
    return _ffi_api.AllocBuffer(  # type: ignore[attr-defined]
        shape,
        dtype,
        data,
        strides,
...
class axis:
    ...
    def spatial(
        ...
        """
        return _ffi_api.AxisSpatial(  # type: ignore[attr-defined]
    ...
    def reduce(
        ...
        res : Var
            The iteration variable.
        """
        return _ffi_api.AxisReduce(  # type: ignore[attr-defined]
            _as_range(dom), binding, dtype
        )
    ...
    def scan(
        ...
        res : Var
            The iteration variable.
        """
        return _ffi_api.AxisScan(  # type: ignore[attr-defined]
            _as_range(dom), binding, dtype
        )
    ...
    def opaque(
        ...
        res : Var
            The iteration variable.
        """
        return _ffi_api.AxisOpaque(  # type: ignore[attr-defined]
            _as_range(dom), binding, dtype
        )
    ...
    *,
    ...
    if stop is None:
        ...
        if hasattr(start, "dtype"):
            ...
            start = 0
    return _ffi_api.Serial(start, stop, annotations, step)  # type: ignore[attr-defined]
    ...
    *,
    ...
    if stop is None:
        ...
        if hasattr(start, "dtype"):
            ...
            start = 0
    return _ffi_api.Parallel(start, stop, annotations, step)  # type: ignore[attr-defined]
    ...
    *,
    ...
    if stop is None:
        ...
        if hasattr(start, "dtype"):
            ...
            start = 0
    return _ffi_api.Vectorized(start, stop, annotations, step)  # type: ignore[attr-defined]
    ...
    *,
    ...
    if stop is None:
        ...
        if hasattr(start, "dtype"):
            ...
            start = 0
    return _ffi_api.Unroll(start, stop, annotations, step)  # type: ignore[attr-defined]
    ...
    *,
    ...
    if thread is None:
        ...
        if hasattr(start, "dtype"):
            ...
            start = 0
    return _ffi_api.ThreadBinding(  # type: ignore[attr-defined]
...
def grid(*extents: PrimExpr) -> frame.ForFrame:
    ...
    res : frame.ForFrame
        The ForFrame.
    """
    return _ffi_api.Grid(extents)  # type: ignore[attr-defined]


def Assert(condition: PrimExpr, message: str) -> frame.AssertFrame:
    ...
    return _ffi_api.Assert(condition, message)  # type: ignore[attr-defined]
...
def LetStmt(
    ...
    *,
    ...
    return _ffi_api.LetStmt(value, type_annotation, var)  # type: ignore[attr-defined]


def Let(
    expr: PrimExpr,
    where: dict[Var, PrimExpr],
) -> PrimExpr:
    """Create a Let expression binding"""
    assert len(where) == 1, "T.Let only allows `where` to have exactly one element"
    var, value = next(iter(where.items()))
...
def let(
    ...
    def let_stmt(v: Var, value: PrimExpr) -> frame.LetFrame:
        return _ffi_api.LegacyLetStmt(v, value)  # type: ignore[attr-defined]
...
def allocate(
    ...
    if isinstance(condition, bool):
        condition = IntImm("bool", condition)
    return _ffi_api.Allocate(  # type: ignore[attr-defined]
...
def attr(node: Any, attr_key: str, value: PrimExpr | str) -> frame.AttrFrame:
    ...
    node = convert(node)
    value = convert(value)
    return _ffi_api.Attr(node, attr_key, value)  # type: ignore[attr-defined]


def While(condition: PrimExpr) -> frame.WhileFrame:
    """Create a while node.
    ...
    if isinstance(condition, bool):
        condition = IntImm("bool", condition)
    return _ffi_api.While(condition)  # type: ignore[attr-defined]
...
def decl_buffer(
    ...
    if strides is not None:
        ...
        strides = []
    return _ffi_api.DeclBuffer(  # type: ignore[attr-defined]
        shape,
        dtype,
        "",
        data,
...
def buffer_store(
    ...
    return _ffi_api.BufferStore(  # type: ignore[attr-defined]
...
def evaluate(value: PrimExpr) -> None:
    ...
    return _ffi_api.Evaluate(value)  # type: ignore[attr-defined]
...
def handle(
    ...
    if dtype is None:
        dtype = "void"
    return _ffi_api.Handle(  # type: ignore[attr-defined]
        dtype,
        storage_scope,
        is_size_var,
        is_unknown_type,
...
def ptr(dtype: str, storage_scope: str = "global", is_size_var: bool = False) -> Var:
    ...
    res : Var
        The pointer.
    """
    return _ffi_api.Ptr(dtype, storage_scope, is_size_var)  # type: ignore[attr-defined]
...
def min(a: PrimExpr, b: PrimExpr) -> PrimExpr:
    ...
    """
    return _ffi_api.min(a, b)  # type: ignore[attr-defined]
...
def max(a: PrimExpr, b: PrimExpr) -> PrimExpr:
    ...
    res : PrimExpr
        The result expression.
    """
    return _ffi_api.max(a, b)  # type: ignore[attr-defined]
...
round = _op_wrapper(_tir_op.round)
