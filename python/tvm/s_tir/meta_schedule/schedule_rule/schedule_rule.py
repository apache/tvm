...
class ScheduleRule(Object):
    ...
    def _initialize_with_tune_context(self, context: TuneContext) -> None:
        ...
        """
        _ffi_api.ScheduleRuleInitializeWithTuneContext(  # type: ignore
            self, context
        )
    ...
    def apply(self, sch: Schedule, block: SBlockRV) -> list[Schedule]:
        ...
        """
        return _ffi_api.ScheduleRuleApply(  #  type: ignore
            self, sch, block
        )
    ...
    def clone(self) -> ScheduleRule:
        ...
        """
        return _ffi_api.ScheduleRuleClone(self)  # type: ignore
...
class _PyScheduleRule(ScheduleRule):
    ...
    def __init__(
        ...
        self.__init_handle_by_constructor__(
            _ffi_api.ScheduleRulePyScheduleRule,  # type: ignore
