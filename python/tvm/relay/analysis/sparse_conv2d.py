...
def _search_gemm_conv_op_weight(expr):
...
def process_params(expr, params, sparsity_threshold):
    """[summary]
    ...
    ret : Namedtuple[weight_name: Array[String], weight_shape: Array[Array[IntImm]]]
        return names of qualified dense weight and the shape in CSR format
    """
    memo = SparseAnalysisResult(weight_name=[], weight_shape=[])
    weight_names = _search_gemm_conv_op_weight(expr)
