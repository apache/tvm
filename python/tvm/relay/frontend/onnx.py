...
def from_onnx(model,
    ...
    big_model: bool
        Whether the size of input model is larger than 2GB

    model_path: str, optional
        The path of the input model, and the external data
        needs under the same dirctory.
        ...
        if hasattr(onnx.checker, 'check_model'):
            ...
            try:
                if not big_model:
                    ...
                    # onnx.checker.check_model(_model) will fail if given >2GB model
