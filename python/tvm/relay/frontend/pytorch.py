...
def tvm_relay_backend(gm, example_inputs, *, scheduler=None, trials=20000):
    ...
    scheduler : str, optional
        Which scheduler to use. Available options are `default`, `auto_scheduler` and `meta_schedule`

    trials : int, optional
        How many trials to use for auto-tuning. Applies to both auto scheduler and meta schedule

    Returns
    -------
    exec_tvm: Callable
        Callable function with compiled TVM module following the same contract as gm.forward
    """
