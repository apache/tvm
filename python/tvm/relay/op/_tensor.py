...
register_shape_func("expand_dims", 0, expand_dims_shape_func)
register_shape_func("cast", 0, cast_shape_func)

register_shape_func("add", 0, broadcast_shape_func)
register_shape_func("subtract", 0, broadcast_shape_func)
register_shape_func("multiply", 0, broadcast_shape_func)
register_shape_func("divide", 0, broadcast_shape_func)
register_shape_func("mod", 0, broadcast_shape_func)
register_shape_func("logical_and", 0, broadcast_shape_func)
register_shape_func("logical_or", 0, broadcast_shape_func)
register_shape_func("equal", 0, broadcast_shape_func)
register_shape_func("not_equal", 0, broadcast_shape_func)
register_shape_func("less", 0, broadcast_shape_func)
register_shape_func("less_equal", 0, broadcast_shape_func)
register_shape_func("greater", 0, broadcast_shape_func)
register_shape_func("greater_equal", 0, broadcast_shape_func)
