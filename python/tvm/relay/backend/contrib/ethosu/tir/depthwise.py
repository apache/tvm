...
def get_depthwise_conv2d_params(
    ...
    if accel_config == vapi.NpuAccelerator.Ethos_U65_512:
        ...
        weight_length = channels * serial_kernel[0] * serial_kernel[1] * math.ceil(channels / 2)
        weight2_length = channels * serial_kernel[0] * serial_kernel[1] * math.floor(channels / 2)
        ...
        weight_length = channels * serial_kernel[0] * serial_kernel[1]
