...
def convert(func, params, sparsity_threshold):
    """Convert a dense func and according parameters to CSR
    ...
    params: Dict[Srting, tvm.nd.array]
        New params with CSR matrix for mutated Expr
    """
    weight_info = process_params(func, params, sparsity_threshold)
    new_func = _run_opt_pass(
        func,
        relay.transform.Conv2dDenseToConv2dSparse(
