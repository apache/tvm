...
@tvm_ffi.register_func("tvm.mrvl.find_value_in_KV_pair")
...
@tvm_ffi.register_func("tvm.mrvl.GetNodesJSONString")
...
@tvm_ffi.register_func("tvm.mrvl.ModifyConstNames")
...
@tvm_ffi.register_func("tvm.mrvl.WriteJsonFile")
...
@tvm_ffi.register_func("tvm.mrvl.CompileModel")
def compile_model(
    symbol_name,
    nodes_json_string,
    consts_json_string,
...
@tvm_ffi.register_func("tvm.mrvl.CleanUpSim")
...
@tvm_ffi.register_func("tvm.mrvl.SearchPath")
...
@tvm_ffi.register_func("tvm.mrvl.JsonToBin")
...
@tvm_ffi.register_func("tvm.mrvl.RunSim")
...
@tvm_ffi.register_func("tvm.mrvl.TempDir")
def get_temp_dir():
