...
@tvm_ffi.register_object("tvm.msc.core.MSCTensor")
...
@tvm_ffi.register_object("tvm.msc.core.BaseJoint")
class BaseJoint(Object):
    """Base class of all MSC Nodes."""


@tvm_ffi.register_object("tvm.msc.core.MSCJoint")
...
@tvm_ffi.register_object("tvm.msc.core.MSCPrim")
...
@tvm_ffi.register_object("tvm.msc.core.WeightJoint")
...
@tvm_ffi.register_object("tvm.msc.core.BaseGraph")
class BaseGraph(Object):
    """Base class of all MSC Graphs."""


@tvm_ffi.register_object("tvm.msc.core.MSCGraph")
...
@tvm_ffi.register_object("tvm.msc.core.WeightGraph")
