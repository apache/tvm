...
@tvm.register_global_func("tvm.msc_tool.codegen_tensor")
def codegen_tensor(
...
@tvm.register_global_func("tvm.msc_tool.codegen_step")
def codegen_step(
...
@tvm.register_global_func("tvm.msc_tool.callback_step")
