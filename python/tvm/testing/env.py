...
Every probe is memoized with :func:`functools.lru_cache`, so the
...
def has_cuda() -> bool:
    """True if a CUDA device is present and the runtime supports it."""
    return _device_exists("cuda")


def has_rocm() -> bool:
    """True if a ROCm device is present and the runtime supports it."""
    return _device_exists("rocm")


def has_vulkan() -> bool:
    """True if a Vulkan device is present and the runtime supports it."""
    return _device_exists("vulkan")


def has_metal() -> bool:
    """True if a Metal device is present and the runtime supports it."""
    return _device_exists("metal")


def has_opencl() -> bool:
    """True if an OpenCL device is present and the runtime supports it."""
    return _device_exists("opencl")


def has_nvptx() -> bool:
    """True if an NVPTX device is present and the runtime supports it."""
    return _device_exists("nvptx")


def has_llvm() -> bool:
    """True if the LLVM backend is available."""
    return _device_exists("llvm")
