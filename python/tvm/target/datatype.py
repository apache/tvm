...
def register(type_name, type_code):
    ...
    """
    get_global_func("tvm.dtype.register_custom_type")(type_name, type_code)
...
def get_type_name(type_code):
    ...
    """
    return get_global_func("tvm.dtype.get_custom_type_name")(type_code)
...
def get_type_code(type_name):
    ...
    type_code : int
        The type code of the custom datatype.
    """
    return get_global_func("tvm.dtype.get_custom_type_code")(type_name)
