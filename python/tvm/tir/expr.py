...
@tvm_ffi.register_object("tvm.tir.Var")
...
@tvm_ffi.register_object("tvm.tir.SizeVar")
class SizeVar(Var):
...
@tvm_ffi.register_object("tvm.tir.IterVar")
...
@tvm_ffi.register_object("tvm.tir.CommReducer")
...
@tvm_ffi.register_object("tvm.tir.Reduce")
...
@tvm_ffi.register_object("tvm.ir.FloatImm")
...
@tvm_ffi.register_object("tvm.ir.IntImm")
...
@tvm_ffi.register_object("tvm.tir.StringImm")  # type: ignore
...
@tvm_ffi.register_object("tvm.tir.Cast")
...
@tvm_ffi.register_object("tvm.tir.Add")
...
@tvm_ffi.register_object("tvm.tir.Sub")
...
@tvm_ffi.register_object("tvm.tir.Mul")
...
@tvm_ffi.register_object("tvm.tir.Div")
...
@tvm_ffi.register_object("tvm.tir.Mod")
...
@tvm_ffi.register_object("tvm.tir.FloorDiv")
...
@tvm_ffi.register_object("tvm.tir.FloorMod")
...
@tvm_ffi.register_object("tvm.tir.Min")
...
@tvm_ffi.register_object("tvm.tir.Max")
...
@tvm_ffi.register_object("tvm.tir.EQ")
class EQ(CmpExpr):
    """EQ node.
...
@tvm_ffi.register_object("tvm.tir.NE")
class NE(CmpExpr):
    """NE node.
...
@tvm_ffi.register_object("tvm.tir.LT")
class LT(CmpExpr):
    """LT node.
...
@tvm_ffi.register_object("tvm.tir.LE")
class LE(CmpExpr):
    """LE node.
...
@tvm_ffi.register_object("tvm.tir.GT")
class GT(CmpExpr):
    """GT node.
...
@tvm_ffi.register_object("tvm.tir.GE")
class GE(CmpExpr):
    """GE node.
...
@tvm_ffi.register_object("tvm.tir.And")
...
@tvm_ffi.register_object("tvm.tir.Or")
...
@tvm_ffi.register_object("tvm.tir.Not")
...
@tvm_ffi.register_object("tvm.tir.Select")
...
@tvm_ffi.register_object("tvm.tir.BufferLoad")
...
@tvm_ffi.register_object("tvm.tir.ProducerLoad")
...
@tvm_ffi.register_object("tvm.tir.Ramp")
...
@tvm_ffi.register_object("tvm.tir.Broadcast")
...
@tvm_ffi.register_object("tvm.tir.Shuffle")
...
@tvm_ffi.register_object("tvm.tir.Call")
...
@tvm_ffi.register_object("tvm.tir.Let")
