...
@tvm_ffi.register_object("tvm.tir.PrimFunc")
class PrimFunc(BaseFunc, Scriptable):
    ...
    def __init__(
        ...
        if attrs is None:
            attrs = tvm.ir.make_node("tvm.ir.DictAttrs")
...
@tvm_ffi.register_object("tvm.tir.TensorIntrin")
...
@tvm_ffi.register_object("tvm.tir.IndexMap")
