...
the constant folding pass (found in `src/relay/transform/fold_constant.cc`_)
...
`src/relay/transform/fold_constant.cc`_).
...
.. _src/relay/transform/fold_constant.cc: https://github.com/apache/incubator-tvm/blob/master/src/relay/transform/fold_constant.cc
