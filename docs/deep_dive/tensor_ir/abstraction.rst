...
- The **block annotation** ``with Ts.sblock("C")`` signifies that the block is the fundamental
  ...
  Core instructions.
- The **iteration annotation** ``Ts.axis.spatial``, indicating that variable ``vi`` is mapped
