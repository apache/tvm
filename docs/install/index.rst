...
:doc:`install TVM from source <install/install-from-source>` to guarantee you
...
:doc:`deployment and integration guide <deploy-and-integration>`.

If you would like to quickly try out TVM or run some demo and tutorials, you
can :doc:`install from Docker <install/docker>`, or install using the
third-party :doc:`TLCPack Python and Conda packages <install/tlcpack>`
