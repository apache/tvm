...
@register_op("memory.alloc_storage", sinfo_inference="InferStructInfoReturnsObject")
class AllocStorage:
...
@register_op("memory.alloc_tensor", sinfo_inference="InferStructInfoMemoryAllocTensor")
class AllocTensor:
...
@register_op("memory.kill_storage", sinfo_inference="InferStructInfoReturnsVoid")
class KillStorage:
...
@register_op("memory.kill_tensor", sinfo_inference="InferStructInfoReturnsVoid")
class KillTensor:
