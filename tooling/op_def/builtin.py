...
@register_op("builtin.alloc_tensor", sinfo_inference="InferStructInfoAllocTensor")
class AllocTensor:
...
@register_op("builtin.stop_lift_params", sinfo_inference="InferStructInfoIdentical")
