...
@register_op("null_value", sinfo_inference="InferStructInfoReturnsObject")
class NullValue:
...
@register_op("shape_of", sinfo_inference="InferStructInfoShapeOf")
class ShapeOf:
...
@register_op("call_tir", sinfo_inference="InferStructInfoReturnFirstSInfoArg", min_num_args=2)
class CallTIR:
    ...
    tir_vars = Optional(
        Shape,
        default=None,
        cc_as_relax=lambda name: name,
    )
    ret = AnyRelaxExpr


@register_op("call_dps_packed", sinfo_inference="InferStructInfoReturnFirstSInfoArg")
class CallDpsPacked:
...
@register_op("call_builtin_with_ctx", sinfo_inference="InferStructInfoReturnFirstSInfoArg")
...
@register_op("make_closure", sinfo_inference="InferStructInfoReturnsObject")
class MakeClosure:
...
@register_op("invoke_closure", sinfo_inference="InferStructInfoReturnFirstSInfoArg")
class InvokeClosure:
    """Invoke a closure.
