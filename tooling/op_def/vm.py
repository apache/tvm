...
@register_op("vm.alloc_storage", sinfo_inference="InferStructInfoReturnsObject")
class AllocStorage:
...
@register_op("vm.alloc_tensor", sinfo_inference="InferStructInfoVMAllocTensor")
class AllocTensor:
...
@register_op("vm.call_tir_dyn", sinfo_inference="InferStructInfoReturnsVoid")
class CallTIRDyn:
