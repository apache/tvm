...
ifndef DMLC_CORE_PATH
  DMLC_CORE_PATH = $(ROOTDIR)/third-party/dmlc-core
endif

ifndef DLPACK_PATH
  DLPACK_PATH = $(ROOTDIR)/third-party/dlpack
endif
...
# Lint scripts
cpplint:
	python3 third_party/dmlc-core/scripts/lint.py vta cpp vta/include vta/src
	python3 third_party/dmlc-core/scripts/lint.py topi cpp topi/include;
	python3 third_party/dmlc-core/scripts/lint.py nnvm cpp nnvm/include nnvm/src;
	python3 third_party/dmlc-core/scripts/lint.py tvm cpp include src verilog\
...
jnilint:
	python3 third_party/dmlc-core/scripts/lint.py tvm4j-jni cpp jvm/native/src
